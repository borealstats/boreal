...
const PLAYERS_2425 = [
  ...
  { rank:35, name:"Koat Thomas",             team:"StFX",                 year:"Y3", pos:"Forward", ht:'6\'5"', wt:null,  sys:"Motion Offense",  pace:80.3, sos:0.75, stat:44.2, fit:52.3, elig:80,  demand:29.3, ctx:78,  ns:49.5, fit1:"St. John's",       fit1s:102.6, fit2:"Indiana",            fit2s:102.0, fit3:"Butler",                fit3s:95.3,  ppg:10.1, rpg:7.2, apg:0.9, best:"10.1 PPG / 7.2 RPG (2024-25, Y3)", fgp:46.8, tpp:12.1, ftp:53.5, spg:1.0, bpg:0.2, tov:2.2, mpg:28.2, gp:17, gs:17, hometown:"Brantford", province:"ON", major:"Human Kinetics", injury:null, verified:true, awards:["🌟 AUS All-Rookie Team (2024-25)"] , season:"2024-25"},
...
const PAST_TRANSFERS = [
  ...
  { id:"past-003", name:"Xavier Spencer",          from:"Carleton (OUA)",    to:"UMass Lowell", conf:"AEC",    pos:"Guard",   uYear:"Y3", season:"2024-25", notes:"Carleton Ravens → America East. Transferred after 2024-25 season." },
  { id:"past-004", name:"Lennart Weber",           from:"Toronto (OUA)",     to:"Bryant",       conf:"NEC",    pos:"Center", uYear:"Y2", season:"2024-25", notes:"Early transfer — Y2 big man. Center → NEC (Bryant). Strong rebounding profile." },
  { id:"past-005", name:"Javier Gilgeous-Alexander", from:"TMU (OUA)",         to:"Troy",         conf:"SBC",    pos:"Guard",   uYear:"Y4", season:"2024-25", notes:"TMU Guard → Sun Belt. Transferred after 2024-25 season." },
];

const PLAYERS_2526 = [
        { rank:1, name:"Christophe Tshibola",    team:"Laval",                year:"Y1", pos:"Guard",   ht:'6\'2"', wt:190,   sys:"Isolation / P&R", pace:71.0, sos:0.90, stat:54.8, fit:70.8, elig:20, demand:62.7, ctx:92,  ns:73.9, fit1:"Maryland",         fit1s:95.7,  fit2:"Marquette",         fit2s:94.6,  fit3:"St. John's",      fit3s:90.8,  ppg:20.9, rpg:4.8, apg:3.5, best:"20.9 PPG / 4.8 RPG / 3.5 APG (2025-26, Y1) — U SPORTS Rookie of the Year; 1st Team All-Canadian; RSEQ MVP; first rookie to win conference MVP since 2001", fgp:45.9, tpp:31.3, ftp:81.6, spg:0.9, bpg:0.0, tov:2.7, mpg:31.4, gp:16, gs:16, hometown:"Montreal", province:"QC", major:"Sociology", injury:null, verified:true, awards:["🏆 U SPORTS Rookie of the Year (2025-26)", "⭐ U SPORTS 1st Team All-Canadian (2025-26)", "🏆 RSEQ Conference MVP (2025-26)", "🌟 U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false},
  { rank:2, name:"Milan John",            team:"Western",     year:"Y3", pos:"Guard",   ht:'6\'3"', wt:null, sys:"Motion Offense",  pace:79.2, sos:1.00, stat:53.8, fit:65.0, elig:12, demand:62.7, ctx:100, ns:73.2, fit1:"Marquette", fit1s:103.0, fit2:"Maryland", fit2s:100.0, fit3:"Indiana", fit3s:98.0, ppg:17.5, rpg:3.8, apg:4.0, best:"17.5 PPG / 3.8 RPG / 4.0 APG (2025-26, Y3) — 47 STL (#5 U SPORTS); 45.7% FG; Western", fgp:45.7, tpp:31.0, ftp:77.9, spg:2.0, bpg:0.3, tov:2.1, mpg:30.6, gp:23, gs:23, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false, statsVerified:true },
  { rank:3, name:"Oliver Engen",            team:"Queen's",              year:"Y2", pos:"Guard",   ht:'6\'4"', wt:null,  sys:"Press System",    pace:86.8, sos:1.00, stat:53.8, fit:34.4, elig:16, demand:62.7, ctx:100, ns:73.2, fit1:"Memphis",           fit1s:91.8,  fit2:"Bucknell",          fit2s:88.0,  fit3:"Missouri",               fit3s:99.8 , ppg:19.9, rpg:4.2, apg:4.6, best:"19.9 PPG / 4.2 RPG / 4.6 APG (2025-26, Y2) — U SPORTS 2nd Team All-Canadian; Queen's" , fgp:52.8, tpp:29.7, ftp:80.6 , spg:1.3, bpg:0.2, tov:1.6, mpg:28.9, gp:31, gs:30, hometown:"Kingston", province:"ON", major:"Engineering", injury:null , verified:true , awards:["⭐ U SPORTS 2nd Team All-Canadian (2025-26)", "🏆 U SPORTS Rookie of the Year (2024-25)", "🏆 OUA Rookie of the Year (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:4, name:"Brice Fandio",          team:"Laurentian",  year:"Y3", pos:"Guard",   ht:'6\'2"', wt:null, sys:"Isolation / P&R", pace:76.0, sos:1.00, stat:56.3, fit:62.0, elig:12, demand:62.7, ctx:100, ns:73.0, fit1:"Buffalo", fit1s:92.0, fit2:"Vermont", fit2s:89.0, fit3:"UMass Lowell", fit3s:86.0, ppg:19.6, rpg:3.1, apg:5.1, best:"19.6 PPG / 3.1 RPG / 5.1 APG (2025-26, Y3) — #12 steals U SPORTS (41); #6 assists U SPORTS (108); 86.9% FT; Laurentian", fgp:41.4, tpp:31.8, ftp:86.9, spg:2.0, bpg:0.0, tov:3.1, mpg:31.0, gp:21, gs:21, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:5, name:"D.J. Jackson", verified:true,            team:"StFX",                 year:"Y4", pos:"Guard",   ht:'6\'4"', wt:190,   sys:"Isolation / P&R", pace:80.3, sos:0.75, stat:65.5, fit:69.7, elig:8,  demand:62.7, ctx:78,  ns:72.1, fit1:"Maryland",           fit1s:113.7, fit2:"St. John's",             fit2s:108.8,  fit3:"Marquette",       fit3s:103.6 , ppg:22.5, rpg:6.5, apg:4.7, best:"22.5 PPG / 6.5 RPG / 4.7 APG (2025-26, Y4) — U SPORTS 1st Team All-Canadian; AUS Player of the Year" , fgp:40.7, tpp:28.3, ftp:82.9 , spg:1.9, bpg:0.4, tov:2.6, mpg:30.9, gp:19, gs:19, hometown:"Dartmouth", province:"NS", major:"Kinesiology", injury:null , verified:true , awards:["⭐ U SPORTS 1st Team All-Canadian (2025-26)", "🏆 AUS Player of the Year (2025-26)", "🏆 AUS Player of the Year (2024-25)", "⭐ U SPORTS 1st Team All-Canadian (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:6, name:"Jeremiah Kwarteng",     team:"York",        year:"Y3", pos:"Guard",   ht:'6\'2"', wt:null, sys:"Isolation / P&R", pace:76.0, sos:1.00, stat:54.3, fit:58.0, elig:12, demand:62.7, ctx:100, ns:71.6, fit1:"Buffalo", fit1s:91.0, fit2:"Vermont", fit2s:88.0, fit3:"Vermont", fit3s:85.0, ppg:19.7, rpg:4.0, apg:3.3, best:"19.7 PPG / 4.0 RPG (2025-26, Y3) — #3 steals U SPORTS (48); 128 FTA (#2 U SPORTS); York", fgp:38.4, tpp:29.3, ftp:70.7, spg:2.3, bpg:0.2, tov:3.2, mpg:30.7, gp:21, gs:21, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:7, name:"Chakib Sedoud",         team:"Laval",       year:"Y2", pos:"Guard",   ht:'6\'4"', wt:null, sys:"Isolation / P&R", pace:71.0, sos:0.90, stat:48.0, fit:68.0, elig:16, demand:62.7, ctx:92, ns:70.3, fit1:"Maryland", fit1s:98.0, fit2:"Marquette", fit2s:95.0, fit3:"St. John's", fit3s:92.0, ppg:16.4, rpg:6.6, apg:1.3, best:"16.4 PPG / 6.6 RPG (2025-26, Y2) — #1 FT% U SPORTS (91.2%); #2 3PT% U SPORTS (48.6%); 53.2% FG; Laval (10 GP)", fgp:53.2, tpp:48.6, ftp:91.2, spg:0.8, bpg:0.3, tov:2.8, mpg:26.1, gp:10, gs:10, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:8, name:"Kymani Pollard",        team:"Lethbridge",  year:"Y3", pos:"Guard",   ht:'6\'3"', wt:null, sys:"Isolation / P&R", pace:78.0, sos:0.80, stat:56.6, fit:60.0, elig:12, demand:62.7, ctx:80, ns:68.9, fit1:"South Florida", fit1s:90.0, fit2:"St. John's", fit2s:89.0, fit3:"Boise State", fit3s:95.0, ppg:21.8, rpg:6.1, apg:2.8, best:"21.8 PPG / 6.1 RPG (2025-26, Y3) — #4 scorer U SPORTS; Lethbridge", fgp:40.4, tpp:28.5, ftp:81.7, spg:1.6, bpg:0.0, tov:3.0, mpg:30.4, gp:20, gs:20, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:9, name:"Munroop Gill",          team:"Brandon",     year:"Y1", pos:"Guard",   ht:'6\'2"', wt:null, sys:"Isolation / P&R", pace:78.0, sos:0.80, stat:51.3, fit:62.0, elig:20, demand:62.7, ctx:69, ns:68.6, fit1:"South Florida", fit1s:91.0, fit2:"Boise State", fit2s:89.0, fit3:"St. John's", fit3s:87.0, ppg:17.9, rpg:3.9, apg:2.2, best:"17.9 PPG / 3.9 RPG (2025-26, Y1) — U SPORTS All-Rookie Team; 54.5% FG; 40.9% 3PT; Brandon", fgp:54.5, tpp:40.9, ftp:75.5, spg:2.3, bpg:0.1, tov:2.7, mpg:29.5, gp:18, gs:10, hometown:null, province:null, major:null, injury:null, verified:true, awards:["🌟 U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },
  { rank:10, name:"Kato Jaro",               team:"Winnipeg",             year:"Y3", pos:"Guard",   ht:'6\'2"', wt:null,  sys:"Pick & Roll",     pace:74.0, sos:0.80, stat:58.9, fit:62.0, elig:12,  demand:62.7, ctx:69,  ns:68.4, fit1:"South Florida",     fit1s:93.0,  fit2:"St. John's",       fit2s:92.0,  fit3:"Boston College", fit3s:100.8,  ppg:17.6, rpg:3.8, apg:5.0, best:"17.6 PPG / 3.8 RPG / 5.0 APG (2025-26, Y3) — U SPORTS 2nd Team All-Canadian; Winnipeg; 95.0% FT", fgp:44.9, tpp:37.9, ftp:95.0, spg:2.7, bpg:0.5, tov:3.6, mpg:33.6, gp:12, gs:12, hometown:"Winnipeg", province:"MB", major:"Business Admin", injury:null, verified:true, awards:["⭐ U SPORTS 2nd Team All-Canadian (2025-26)", "⭐ CW 2nd Team All-Star (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:11, name:"Jack Tunstill",         team:"Guelph",      year:"Y4", pos:"Wing",    ht:'6\'4"', wt:null, sys:"Motion Offense",  pace:74.5, sos:1.00, stat:52.3, fit:62.0, elig:8, demand:46.0, ctx:100, ns:67.5, fit1:"Buffalo", fit1s:90.0, fit2:"Vermont", fit2s:87.0, fit3:"Vermont", fit3s:85.0, ppg:13.8, rpg:6.6, apg:2.1, best:"13.8 PPG / 6.6 RPG (2025-26, Y4) — #4 steals U SPORTS (47); 52.4% FG; Guelph", fgp:52.4, tpp:32.5, ftp:72.6, spg:2.2, bpg:0.9, tov:2.0, mpg:26.1, gp:21, gs:21, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:12, name:"Isaac Simon",             team:"Alberta",              year:"Y4", pos:"Guard",   ht:'6\'2"', wt:180,   sys:"Isolation / P&R", pace:72.5, sos:0.85, stat:49.7, fit:70.2, elig:8,  demand:62.7, ctx:73,  ns:67.0, fit1:"Marquette",         fit1s:112.6, fit2:"Seton Hall",       fit2s:105.5, fit3:"Maryland",        fit3s:104.7 , ppg:15.7, rpg:4.3, apg:4.0, best:"15.7 PPG / 4.3 RPG / 4.0 APG (2025-26, Y4) — Alberta" , fgp:46.9, tpp:28.7, ftp:71.1 , spg:1.1, bpg:0.2, tov:2.3, mpg:29.4, gp:23, gs:23, hometown:"Edmonton", province:"AB", major:"Business", injury:null , verified:true , awards:["⭐ CW 2nd Team All-Star (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:13, name:"Aubrey Dorey-Havens",     team:"Carleton",             year:"Y4", pos:"Guard",   ht:'6\'3"', wt:null,  sys:"Motion Offense",  pace:73.0, sos:1.00, stat:47.5, fit:51.8, elig:8,  demand:62.7, ctx:100, ns:67.0, fit1:"Butler",            fit1s:102.5, fit2:"Gonzaga",          fit2s:97.5,  fit3:"Missouri",          fit3s:106.8,  ppg:14.7, rpg:3.2, apg:4.7, best:"14.7 PPG / 3.2 RPG / 4.7 APG (2025-26, Y4) — National Champion Carleton; tournament MVP; 35 pts gold medal game", fgp:43.3, tpp:38.6, ftp:76.2, spg:0.9, bpg:0.2, tov:2.0, mpg:29.9, gp:21, gs:21, hometown:"North Vancouver", province:"BC", major:"Business", injury:null, verified:true, awards:["🏆 U SPORTS National Champion (2025-26)", "🏅 Final 8 Tournament MVP (2025-26)", "⭐ OUA 2nd Team All-Star (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:14, name:"Lydell Husbands",       team:"Dalhousie",   year:"Y3", pos:"Guard",   ht:'6\'2"', wt:null, sys:"Motion Offense",  pace:76.0, sos:0.75, stat:54.5, fit:58.0, elig:12, demand:62.7, ctx:78, ns:66.9, fit1:"Vermont",  fit1s:88.0, fit2:"Maine", fit2s:85.0, fit3:"UMass Lowell", fit3s:82.0, ppg:12.3, rpg:6.9, apg:5.5, best:"12.3 PPG / 6.9 RPG / 5.5 APG (2025-26, Y3) — #2 steals U SPORTS (50); #4 assists U SPORTS; Dalhousie", fgp:34.6, tpp:25.0, ftp:63.9, spg:2.5, bpg:0.5, tov:3.4, mpg:29.9, gp:20, gs:19, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:15, name:"Alvin Icyogere",           team:"Nipissing",            year:"Y3", pos:"Guard",   ht:'6\'2"', wt:null,  sys:"Isolation / P&R", pace:76.4, sos:0.90, stat:34.2, fit:71.8, elig:12,  demand:62.7, ctx:92,  ns:66.6, fit1:"Maryland",           fit1s:113.7, fit2:"Marquette",        fit2s:103.6, fit3:"St. John's", fit3s:108.8 , ppg:10.3, rpg:4.1, apg:2.1, best:"10.3 PPG / 4.1 RPG (2025-26, Y3) — Nipissing" , fgp:35.7, tpp:28.1, ftp:82.9 , spg:0.7, bpg:0.2, tov:2.6, mpg:27.9, gp:19, gs:17, hometown:"Ottawa", province:"ON", major:"Health Sciences", injury:null , verified:true , awards:[] , season:"2025-26", needsUpdate:false},
  { rank:16, name:"Kevin Toth",            team:"Toronto Metropolitan", year:"Y3", pos:"Guard", ht:'6\'1"', wt:null, sys:"Isolation / P&R", pace:76.4, sos:1.00, stat:37.0, fit:58.0, elig:12, demand:62.7, ctx:100, ns:66.4, fit1:"Vermont", fit1s:85.0, fit2:"Buffalo", fit2s:83.0, fit3:"UMass Lowell", fit3s:80.0, ppg:6.9, rpg:4.0, apg:5.5, best:"6.9 PPG / 4.0 RPG / 5.5 APG (2025-26, Y3) — #2 assists U SPORTS (120); Final 8 participant; TMU", fgp:31.6, tpp:25.0, ftp:70.8, spg:0.7, bpg:0.2, tov:2.7, mpg:25.0, gp:22, gs:18, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:17, name:"Jakub Dobiech",         team:"Queen's",     year:"Y2", pos:"Guard",   ht:'6\'3"', wt:null, sys:"Motion Offense",  pace:75.0, sos:1.00, stat:30.2, fit:62.0, elig:16, demand:62.7, ctx:100, ns:66.0, fit1:"Buffalo", fit1s:90.0, fit2:"Vermont", fit2s:87.0, fit3:"Vermont", fit3s:84.0, ppg:10.6, rpg:2.0, apg:1.3, best:"10.6 PPG / 2.0 RPG (2025-26, Y2) — #3 3PT% U SPORTS (46.8%); 49.7% FG; Queen's", fgp:49.7, tpp:46.8, ftp:80.0, spg:0.2, bpg:0.0, tov:1.1, mpg:18.2, gp:22, gs:5, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:18, name:"Ryan Regault",            team:"Acadia",               year:"Y2", pos:"Guard",   ht:'6\'0"', wt:null,  sys:"Motion Offense",  pace:80.1, sos:0.75, stat:49.6, fit:50.4, elig:16, demand:62.7, ctx:78,  ns:65.4, fit1:"Buffalo",           fit1s:87.5,  fit2:"Bowling Green",    fit2s:84.0,  fit3:"Missouri",  fit3s:106.8 , ppg:14.9, rpg:4.8, apg:4.8, best:"14.9 PPG / 4.8 RPG / 4.8 APG (2025-26, Y2) — AUS Championship MVP; Acadia" , fgp:38.0, tpp:34.5, ftp:82.1, spg:1.3, bpg:0.1, tov:3.1, mpg:27.4, gp:20, gs:20, hometown:"Scarborough", province:"ON", major:"Law and Society", injury:null, verified:true, awards:["🏆 AUS Championship MVP (2025-26)", "🏆 AUS Rookie of the Year (2024-25)", "🌟 AUS All-Rookie Team (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:19, name:"Emmanuel Otong",          team:"Windsor",              year:"Y3", pos:"Forward", ht:'6\'6"', wt:null,  sys:"Isolation / P&R", pace:78.8, sos:1.00, stat:41.8, fit:70.6, elig:12,  demand:29.3, ctx:100, ns:64.4, fit1:"Marquette",          fit1s:106.2, fit2:"Ole Miss",    fit2s:99.6,  fit3:"Georgetown",        fit3s:98.4 , ppg:11.5, rpg:5.7, apg:1.7, best:"11.5 PPG / 5.7 RPG (2025-26, Y3) — Windsor; 24 blocks" , fgp:46.8, tpp:28.3, ftp:64.0 , spg:0.4, bpg:0.9, tov:1.9, mpg:27.3, gp:27, gs:27, hometown:"Windsor", province:"ON", major:"Kinesiology", injury:null , verified:true , awards:[] , season:"2025-26", needsUpdate:false},
  { rank:20, name:"Marcus Barnes",           team:"UNB",                  year:"Y4", pos:"Guard",   ht:'6\'3"', wt:null,  sys:"Motion Offense",  pace:74.0, sos:0.75, stat:51.9, fit:52.3, elig:8,  demand:62.7, ctx:78,  ns:63.8, fit1:"Indiana",           fit1s:114.0, fit2:"Butler",            fit2s:110.3, fit3:"Gonzaga",               fit3s:109.1,  ppg:19.2, rpg:4.0, apg:3.1, best:"19.2 PPG / 4.0 RPG (2025-26, Y4) — U SPORTS 2nd Team All-Canadian; DPOY nominee; UNB", fgp:36.7, tpp:28.0, ftp:77.0, spg:1.7, bpg:0.3, tov:2.0, mpg:31.3, gp:20, gs:20, hometown:"Kitchener", province:"ON", major:"Business Admin", injury:null, verified:true, awards:["⭐ U SPORTS 2nd Team All-Canadian (2025-26)", "⭐ AUS 2nd Team All-Star (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:21, name:"Renoldo Robinson",        team:"Victoria",             year:"Y4", pos:"Guard",   ht:'6\'3"', wt:null,  sys:"Transition",      pace:82.3, sos:0.85, stat:50.6, fit:44.6, elig:8,  demand:62.7, ctx:73,  ns:63.3, fit1:"Memphis",           fit1s:97.1,  fit2:"Gonzaga",          fit2s:90.8,  fit3:"Boston College",               fit3s:93.8 , ppg:14.0, rpg:4.9, apg:4.4, best:"14.0 PPG / 4.9 RPG / 4.4 APG (2025-26, Y4) — National Champion Victoria; 114 AST" , fgp:41.2, tpp:28.2, ftp:75.6 , spg:2.0, bpg:0.3, tov:2.3, mpg:24.9, gp:26, gs:17, hometown:"Victoria", province:"BC", major:"Kinesiology", injury:null , verified:true , awards:["🥉 U SPORTS Bronze Medal (2025-26)", "⭐ CW 1st Team All-Star (2024-25)", "🏆 U SPORTS National Champion (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:22, name:"Charles Robert",          team:"Bishop's",             year:"Y4", pos:"Forward", ht:'6\'6"', wt:null,  sys:"Pick & Roll",     pace:71.0, sos:0.90, stat:56.2, fit:64.8, elig:8,  demand:29.3, ctx:84,  ns:63.1, fit1:"St. John's",       fit1s:96.8,  fit2:"Kansas State",     fit2s:84.4,  fit3:"Indiana",   fit3s:80.8,  ppg:17.0, rpg:6.0, apg:3.7, best:"17.0 PPG / 6.0 RPG / 3.7 APG (2025-26, Y4) — U SPORTS 2nd Team All-Canadian; Bishop's finalist; 52.3% FG", fgp:52.3, tpp:35.5, ftp:52.4, spg:0.5, bpg:0.9, tov:2.7, mpg:28.7, gp:22, gs:22, hometown:"Vaudreuil-Dorion", province:"QC", major:"Mathematics", injury:null, verified:true, awards:["⭐ U SPORTS 2nd Team All-Canadian (2025-26)", "🥈 U SPORTS Silver Medal (2025-26)", "⭐ U SPORTS 1st Team All-Canadian (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:23, name:"Luke Grace",            team:"Windsor",     year:"Y4", pos:"Forward", ht:'6\'8"', wt:null, sys:"Isolation / P&R", pace:78.8, sos:1.00, stat:53.0, fit:52.0, elig:8, demand:29.3, ctx:100, ns:63.1, fit1:"Illinois", fit1s:104.0, fit2:"Indiana", fit2s:99.0, fit3:"Tennessee", fit3s:97.0, ppg:16.6, rpg:9.3, apg:0.9, best:"16.6 PPG / 9.3 RPG (2025-26, Y4) — 56.0% FG; 207 total reb; Windsor", fgp:56.0, tpp:4.5, ftp:75.6, spg:1.4, bpg:0.4, tov:1.4, mpg:28.7, gp:27, gs:26, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:24, name:"Jasha'jaun Downey",       team:"Saint Mary's",         year:"Y3", pos:"Guard",   ht:'6\'3"', wt:null,  sys:"Motion Offense",  pace:77.0, sos:0.75, stat:44.1, fit:52.7, elig:12,  demand:62.7, ctx:78,  ns:62.9, fit1:"Gonzaga",           fit1s:102.9, fit2:"Butler",           fit2s:102.7, fit3:"Missouri",          fit3s:106.8 , ppg:16.3, rpg:3.5, apg:2.5, best:"16.3 PPG / 3.5 RPG (2025-26, Y3) — Saint Mary's" , fgp:36.6, tpp:29.7, ftp:76.1 , spg:1.2, bpg:0.2, tov:2.1, mpg:28.4, gp:19, gs:17, hometown:"Halifax", province:"NS", major:"Health Sciences", injury:null , verified:true , awards:[] , season:"2025-26", needsUpdate:false},
  { rank:25, name:"Eric Armstrong",           team:"Guelph",               year:"Y4", pos:"Forward", ht:'6\'5"', wt:210,   sys:"Halfcourt",       pace:74.5, sos:0.90, stat:50.7, fit:64.3, elig:8,  demand:29.3, ctx:92,  ns:62.5, fit1:"Western Michigan",  fit1s:89.6,  fit2:"Central Michigan", fit2s:87.5,  fit3:"South Carolina",            fit3s:96.6 , ppg:15.4, rpg:6.7, apg:2.3, best:"15.4 PPG / 6.7 RPG (2025-26, Y4) — 47.8% FG" , fgp:47.8, tpp:31.6, ftp:76.9 , spg:1.0, bpg:0.7, tov:2.4, mpg:27.5, gp:27, gs:27, hometown:"Guelph", province:"ON", major:"Business", injury:null , verified:true , awards:[] , season:"2025-26", needsUpdate:false},
  { rank:26, name:"Ares Culley-Bremner",   team:"McMaster",    year:"Y4", pos:"Forward", ht:'6\'7"', wt:null, sys:"Motion Offense",  pace:73.0, sos:1.00, stat:53.0, fit:52.0, elig:8, demand:29.3, ctx:100, ns:62.4, fit1:"Buffalo", fit1s:88.0, fit2:"Maine", fit2s:84.0, fit3:"Vermont", fit3s:82.0, ppg:9.0, rpg:9.0, apg:2.5, best:"9.0 PPG / 9.0 RPG (2025-26, Y4) — #1 blocker U SPORTS (78 BLK); 50.9% FG; McMaster", fgp:50.9, tpp:33.3, ftp:35.0, spg:1.3, bpg:3.7, tov:2.6, mpg:30.5, gp:21, gs:19, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:27, name:"Easton Thimm",            team:"Saskatchewan",         year:"Y3", pos:"Forward", ht:'6\'9"', wt:224,   sys:"Pick & Roll",     pace:72.0, sos:0.85, stat:60.8, fit:58.4, elig:12,  demand:29.3, ctx:69,  ns:62.3, fit1:"St. John's",       fit1s:96.8,  fit2:"Kansas State",      fit2s:84.4,  fit3:"Indiana",               fit3s:80.8 , ppg:16.4, rpg:12.3, apg:2.5, best:"16.4 PPG / 12.3 RPG (2025-26, Y3) — CW RPG leader; 59.7% FG; no 3-point attempts" , fgp:59.7, tpp:0.0, ftp:75.9, spg:1.0, bpg:0.6, tov:2.7, mpg:32.3, gp:20, gs:20, hometown:"Saskatoon", province:"SK", major:"Business", injury:null, verified:true, awards:["🏀 CEBL Draft Pick — SK Rattlers, 23rd Overall (2025)", "🏆 CW Rookie of the Year (2023-24)"] , season:"2025-26", needsUpdate:false},
  { rank:28, name:"Chris-Evrard Malonga",  team:"Nipissing",   year:"Y3", pos:"Forward", ht:'6\'7"', wt:null, sys:"Isolation / P&R", pace:76.4, sos:1.00, stat:48.6, fit:50.0, elig:12, demand:29.3, ctx:100, ns:62.1, fit1:"Illinois", fit1s:102.0, fit2:"Indiana", fit2s:97.0, fit3:"Tennessee", fit3s:95.0, ppg:12.3, rpg:7.5, apg:1.0, best:"12.3 PPG / 7.5 RPG (2025-26, Y3) — 58.8% FG; 32 BLK; Nipissing", fgp:58.8, tpp:28.6, ftp:57.4, spg:0.4, bpg:1.6, tov:1.6, mpg:25.8, gp:20, gs:17, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:29, name:"Étienne Gagnon",          team:"Bishop's",             year:"Y4", pos:"Forward", ht:'6\'7"', wt:210,   sys:"Pick & Roll",     pace:71.0, sos:0.90, stat:49.2, fit:64.8, elig:8,  demand:29.3, ctx:84,  ns:61.0, fit1:"St. John's",       fit1s:96.8,  fit2:"Kansas State",     fit2s:84.4,  fit3:"Indiana",   fit3s:80.8 , ppg:12.2, rpg:10.2, apg:1.4, best:"12.2 PPG / 10.2 RPG (2025-26, Y4) — U SPORTS Defensive Player of the Year; Bishop's finalist; 55.1% FG" , fgp:55.1, tpp:33.3, ftp:71.4, spg:1.6, bpg:0.3, tov:2.1, mpg:27.6, gp:16, gs:16, hometown:"Longueuil", province:"QC", major:"Sociology", injury:null, verified:true, awards:["🏆 U SPORTS Defensive Player of the Year (2025-26)", "🥈 U SPORTS Silver Medal (2025-26)", "🏆 RSEQ Defensive Player of the Year (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:30, name:"Dario Lopez",             team:"UFV",                  year:"Y4", pos:"Forward", ht:'6\'3"', wt:null,  sys:"Isolation / P&R", pace:79.0, sos:0.80, stat:50.4, fit:70.5, elig:8,  demand:29.3, ctx:69,  ns:60.9, fit1:"Marquette",          fit1s:106.2, fit2:"Ole Miss",         fit2s:99.6,  fit3:"Georgetown",   fit3s:98.4 , ppg:15.2, rpg:5.9, apg:2.2, best:"15.2 PPG / 5.9 RPG / 2.2 APG (2025-26, Y4) — 53.8% FG; UFV", fgp:53.8, tpp:32.0, ftp:76.9, spg:1.1, bpg:0.7, tov:2.4, mpg:27.1, gp:13, gs:13, hometown:"Abbotsford", province:"BC", major:"Business", injury:null, verified:true, awards:["⭐ CW 2nd Team All-Star (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:31, name:"Ismael Konate",         team:"Laurentian",  year:"Y3", pos:"Forward", ht:'6\'8"', wt:null, sys:"Isolation / P&R", pace:76.0, sos:1.00, stat:44.0, fit:50.0, elig:12, demand:29.3, ctx:100, ns:60.6, fit1:"Illinois", fit1s:104.0, fit2:"Indiana", fit2s:99.0, fit3:"Tennessee", fit3s:97.0, ppg:11.2, rpg:10.3, apg:0.7, best:"11.2 PPG / 10.3 RPG (2025-26, Y3) — #4 rebounds U SPORTS; 99 offensive reb (#1 U SPORTS); Laurentian", fgp:43.0, tpp:25.9, ftp:78.7, spg:0.9, bpg:0.6, tov:1.5, mpg:26.3, gp:22, gs:21, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:32, name:"Owen Urquhart",         team:"Western",     year:"Y3", pos:"Forward", ht:'6\'7"', wt:null, sys:"Motion Offense",  pace:79.2, sos:1.00, stat:41.8, fit:50.0, elig:12, demand:29.3, ctx:100, ns:60.4, fit1:"Illinois", fit1s:103.0, fit2:"Indiana", fit2s:97.0, fit3:"Tennessee", fit3s:95.0, ppg:7.5, rpg:4.7, apg:2.6, best:"7.5 PPG / 4.7 RPG / 1.4 BPG (2025-26, Y3) — 65.4% FG (#2 U SPORTS); 1.4 BPG; Western", fgp:65.4, tpp:null, ftp:60.0, spg:0.7, bpg:1.4, tov:1.0, mpg:16.3, gp:21, gs:2, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false, statsVerified:true },
  { rank:33, name:"Shadynn Smid",            team:"Victoria",             year:"Y4", pos:"Forward", ht:'6\'4"', wt:null,  sys:"Transition",      pace:82.3, sos:0.85, stat:41.8, fit:44.6, elig:8,  demand:29.3, ctx:73,  ns:60.4, fit1:"Memphis",           fit1s:93.0,  fit2:"Gonzaga",          fit2s:87.5,  fit3:"Wake Forest",               fit3s:95.0 , ppg:13.4, rpg:5.6, apg:1.1, best:"13.4 PPG / 5.6 RPG (2025-26, Y4) — National Champion Victoria; 55.7% FG" , fgp:55.7, tpp:32.9, ftp:75.7, spg:1.2, bpg:0.7, tov:1.7, mpg:25.4, gp:26, gs:25, hometown:"Victoria", province:"BC", major:"Kinesiology", injury:null, verified:true, awards:["🥉 U SPORTS Bronze Medal (2025-26)", "🏆 U SPORTS National Champion (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:34, name:"Owen Smith",            team:"UPEI",        year:"Y2", pos:"Guard",   ht:'6\'1"', wt:null, sys:"Motion Offense",  pace:76.0, sos:0.75, stat:30.2, fit:55.0, elig:16, demand:62.7, ctx:78, ns:60.1, fit1:"Vermont", fit1s:88.0, fit2:"Maine", fit2s:85.0, fit3:"UMass Lowell", fit3s:83.0, ppg:11.4, rpg:2.3, apg:1.1, best:"11.4 PPG / 2.3 RPG (2025-26, Y2) — #2 FT% U SPORTS (90.2%); 36.7% 3PT; UPEI", fgp:41.6, tpp:36.7, ftp:90.2, spg:0.4, bpg:0.0, tov:0.8, mpg:19.6, gp:17, gs:4, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:35, name:"Devawn White",          team:"Saint Mary's", year:"Y3", pos:"Wing",    ht:'6\'4"', wt:null, sys:"Motion Offense",  pace:77.0, sos:0.75, stat:43.7, fit:52.0, elig:12, demand:46.0, ctx:78, ns:59.5, fit1:"Vermont", fit1s:87.0, fit2:"Maine", fit2s:84.0, fit3:"UMass Lowell", fit3s:80.0, ppg:9.6, rpg:7.8, apg:1.7, best:"9.6 PPG / 7.8 RPG (2025-26, Y3) — #1 steals U SPORTS (51); Saint Mary's", fgp:43.0, tpp:42.4, ftp:63.2, spg:2.6, bpg:0.4, tov:1.5, mpg:26.8, gp:20, gs:19, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:36, name:"Ryan Gallagher",        team:"Victoria",    year:"Y4", pos:"Guard",   ht:'6\'2"', wt:null, sys:"Transition",      pace:82.3, sos:0.85, stat:27.3, fit:58.0, elig:8, demand:62.7, ctx:73, ns:59.0, fit1:"Gonzaga", fit1s:91.0, fit2:"Memphis", fit2s:88.0, fit3:"Wake Forest", fit3s:86.0, ppg:7.3, rpg:2.0, apg:1.2, best:"7.3 PPG (2025-26, Y4) — #1 3PT% U SPORTS (53.4%); 55.2% FG; 26 GP Victoria", fgp:55.2, tpp:53.4, ftp:14.3, spg:0.4, bpg:0.1, tov:0.8, mpg:15.8, gp:26, gs:4, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:37, name:"Tye Cotie",             team:"Western",     year:"Y4", pos:"Center",  ht:'6\'8"', wt:null, sys:"Motion Offense",  pace:79.2, sos:1.00, stat:43.2, fit:52.0, elig:8, demand:14.0, ctx:100, ns:57.3, fit1:"Illinois", fit1s:105.0, fit2:"Indiana", fit2s:99.0, fit3:"Tennessee", fit3s:97.0, ppg:9.5, rpg:6.5, apg:1.6, best:"9.5 PPG / 6.5 RPG (2025-26, Y4) — 68.1% FG (#1 U SPORTS); 25 BLK; Western", fgp:68.1, tpp:null, ftp:57.4, spg:0.8, bpg:1.1, tov:1.2, mpg:21.1, gp:23, gs:22, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false, statsVerified:true },
  { rank:38, name:"Mohamed Keita",         team:"Laval",       year:"Y3", pos:"Center",  ht:'6\'9"', wt:null, sys:"Isolation / P&R", pace:71.0, sos:0.90, stat:43.2, fit:48.0, elig:12, demand:14.0, ctx:92, ns:57.3, fit1:"Illinois", fit1s:103.0, fit2:"Indiana", fit2s:98.0, fit3:"Tennessee", fit3s:96.0, ppg:5.1, rpg:7.0, apg:0.2, best:"5.1 PPG / 7.0 RPG (2025-26, Y3) — #5 blocks U SPORTS (31); 65.9% FG; Laval (13 GP)", fgp:65.9, tpp:null, ftp:60.0, spg:0.5, bpg:2.4, tov:1.1, mpg:17.8, gp:13, gs:9, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },
  { rank:39, name:"Conner Landell",         team:"UNB",                  year:"Y2", pos:"Center",  ht:'6\'9"', wt:228,   sys:"Motion Offense",  pace:76.0, sos:0.75, stat:50.1, fit:52.5, elig:16,  demand:14.0, ctx:82,  ns:56.8, fit1:"Illinois",         fit1s:110.2, fit2:"Indiana",           fit2s:99.0,  fit3:"Tennessee",       fit3s:98.1,  ppg:11.8, rpg:11.6, apg:0.8, best:"11.8 PPG / 11.6 RPG (2025-26, Y2) — #2 rebounder in U SPORTS; 54.7% FG; CEBL draft pick (Brampton, 19th overall)", fgp:54.7, tpp:0.0, ftp:50.0, spg:0.3, bpg:1.1, tov:2.1, mpg:28.3, gp:20, gs:20, hometown:"Niagara Falls", province:"ON", major:"Arts", injury:null, verified:true, awards:["🏀 CEBL Draft Pick — Brampton Honey Badgers, 19th Overall (2025)"], season:"2025-26", needsUpdate:false},
  { rank:40, name:"Ethan Boag",              team:"Victoria",             year:"Y3", pos:"Forward", ht:'6\'2"', wt:null,  sys:"Transition",      pace:82.3, sos:0.85, stat:44.3, fit:44.6, elig:12,  demand:29.3, ctx:73,  ns:56.2, fit1:"Memphis",           fit1s:97.6,  fit2:"Gonzaga",          fit2s:91.3,  fit3:"Wake Forest",               fit3s:95.0 , ppg:13.9, rpg:5.2, apg:2.3, best:"13.9 PPG / 5.2 RPG (2025-26, Y3) — U SPORTS 1st Team All-Canadian; CW Player of the Year; National Champion Victoria" , fgp:44.6, tpp:33.3, ftp:74.5 , spg:0.7, bpg:0.5, tov:1.8, mpg:26.0, gp:26, gs:26, hometown:"Victoria", province:"BC", major:"Business", injury:null , verified:true , awards:["⭐ U SPORTS 1st Team All-Canadian (2025-26)", "🥉 U SPORTS Bronze Medal (2025-26)", "🏆 CW Player of the Year (2025-26)", "🏆 U SPORTS National Champion (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:41, name:"Koat Thomas",             team:"StFX",                 year:"Y4", pos:"Forward", ht:'6\'5"', wt:null,  sys:"Motion Offense",  pace:80.3, sos:0.75, stat:44.0, fit:52.3, elig:8,  demand:29.3, ctx:78,  ns:55.9, fit1:"St. John's",       fit1s:102.6, fit2:"Indiana",            fit2s:102.0, fit3:"Butler",                fit3s:95.3,  ppg:12.2, rpg:6.5, apg:2.1, best:"12.2 PPG / 6.5 RPG (2025-26, Y4) — StFX", fgp:47.6, tpp:25.0, ftp:57.4, spg:1.3, bpg:0.3, tov:2.5, mpg:31.4, gp:20, gs:20, hometown:"Brantford", province:"ON", major:"Human Kinetics", injury:null, verified:true, awards:["🌟 AUS All-Rookie Team (2024-25)"] , season:"2025-26", needsUpdate:false},
  { rank:42, name:"Geoffrey James",          team:"Victoria",             year:"Y4", pos:"Forward", ht:'6\'5"', wt:null,  sys:"Transition",      pace:82.3, sos:0.85, stat:44.7, fit:44.6, elig:8,  demand:29.3, ctx:73,  ns:55.3, fit1:"Memphis",           fit1s:94.0,  fit2:"Gonzaga",          fit2s:88.5,  fit3:"Wake Forest",               fit3s:95.0 , ppg:12.0, rpg:4.8, apg:3.5, best:"12.0 PPG / 4.8 RPG / 3.5 APG (2025-26, Y4) — Final 8 All-Star; DPOY nominee; Victoria bronze" , fgp:40.7, tpp:33.8, ftp:82.1, spg:2.2, bpg:0.1, tov:1.5, mpg:28.3, gp:24, gs:24, hometown:"Victoria", province:"BC", major:"Kinesiology", injury:null, verified:true, awards:["🥉 U SPORTS Bronze Medal (2025-26)", "🏆 U SPORTS National Champion (2024-25)"] , season:"2025-26", needsUpdate:false},
];
...
const PLAYERS_W_2526 = [
  ...
  { rank:1, name:"Myriam Kone", team:"Toronto Metropolitan", year:"Y4", pos:"Guard", ht:'5\'8"', wt:null, sys:"Isolation / P&R", pace:76.0, sos:1.00, stat:65.5, fit:68.0, elig:8, demand:47.9, ctx:100, ns:73.2, fit1:"Maryland", fit1s:96.0, fit2:"Michigan", fit2s:93.0, fit3:"St. John's", fit3s:90.0, ppg:21.2, rpg:6.5, apg:3.3, best:"1st Team All-Canadian (2025-26, Y4) — TMU", fgp:43.6, tpp:26.3, ftp:72.6, spg:2.9, bpg:0.9, tov:3.6, mpg:33.6, gp:27, gs:27, hometown:"Edmonton", province:"AB", major:"Psychology", injury:null, verified:true, awards:["⭐ U SPORTS 1st Team All-Canadian (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:2, name:"Sydney Cowan", team:"Western", year:"Y1", pos:"Guard", ht:'5\'9"', wt:null, sys:"Motion Offense", pace:79.0, sos:1.00, stat:48.4, fit:60.0, elig:20, demand:47.9, ctx:100, ns:69.8, fit1:"Marquette", fit1s:94.0, fit2:"Maryland", fit2s:92.0, fit3:"Michigan", fit3s:90.0, ppg:16.5, rpg:3.2, apg:2.4, best:"16.3 PPG (2025-26, Y1) — U SPORTS Rookie of the Year (Kathy Shields); OUA Rookie of the Year; 358 total pts (#8 U SPORTS); started 21/22 OUA games; game-winning 3PT vs Ottawa", fgp:40.4, tpp:34.4, ftp:72.1, spg:2.8, bpg:0.3, tov:0.8, mpg:28.6, gp:25, gs:24, hometown:"London", province:"ON", major:null, injury:null, verified:true, awards:["🏆 U SPORTS Rookie of the Year — Kathy Shields Award (2025-26)", "🏆 OUA Rookie of the Year (2025-26)", "🌟 U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:3, name:"Kyana-Jade Poulin", team:"Carleton", year:"Y4", pos:"Guard", ht:'5\'7"', wt:null, sys:"Motion Offense", pace:74.0, sos:1.0, stat:56.4, fit:65.0, elig:8, demand:47.9, ctx:92, ns:68.8, fit1:"Villanova", fit1s:92.0, fit2:"Creighton", fit2s:90.0, fit3:"Providence", fit3s:87.0, ppg:19.8, rpg:7.3, apg:3.2, best:"U SPORTS 2nd Team All-Canadian (2025-26); Carleton; Montreal native; Applied Linguistics major", fgp:41.7, tpp:36.2, ftp:77.8, spg:1.3, bpg:0.1, tov:4.0, mpg:31.1, gp:22, gs:22, hometown:"Montreal", province:"QC", major:"Applied Linguistics", injury:null, verified:true, awards:["⭐ U SPORTS 2nd Team All-Canadian (2025-26)", "⭐ OUA All-Star (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:4, name:"Hailey Franco DeRyck", team:"Toronto Metropolitan", year:"Y3", pos:"Forward", ht:'6\'0"', wt:null, sys:"Isolation / P&R", pace:76.0, sos:1.00, stat:60.4, fit:65.0, elig:12, demand:27.2, ctx:100, ns:68.2, fit1:"Maryland", fit1s:92.0, fit2:"Michigan", fit2s:89.0, fit3:"Marquette", fit3s:87.0, ppg:9.4, rpg:12.8, apg:2.7, best:"DPOY nominee (2025-26) — TMU", fgp:48.7, tpp:33.3, ftp:40.6, spg:2.3, bpg:1.9, tov:2.5, mpg:28.9, gp:28, gs:28, hometown:"Etobicoke", province:"ON", major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },

  { rank:5, name:"Jacqueline Urban", team:"Carleton", year:"Y3", pos:"Guard", ht:'5\'8"', wt:null, sys:"Motion Offense", pace:74.0, sos:1.0, stat:48.0, fit:62.0, elig:12, demand:47.9, ctx:85, ns:66.0, fit1:"UConn", fit1s:88.0, fit2:"Marquette", fit2s:86.0, fit3:"Creighton", fit3s:84.0, ppg:13.0, rpg:10.2, apg:1.0, best:"OUA 1st Team All-Star (2024-25); Carleton Ravens; key backcourt piece for perennial OUA contender", fgp:42.0, tpp:28.6, ftp:76.0, spg:1.6, bpg:0.5, tov:1.9, mpg:29.9, gp:22, gs:22, hometown:null, province:null, major:null, injury:null, verified:true, awards:["⭐ OUA 1st Team All-Star (2024-25)"], season:"2025-26", needsUpdate:false },

  { rank:6, name:"Kaillie Hall", team:"Toronto Metropolitan", year:"Y4", pos:"Guard", ht:'5\'9"', wt:null, sys:"Isolation / P&R", pace:76.0, sos:1.0, stat:44.2, fit:63.0, elig:8, demand:47.9, ctx:85, ns:64.3, fit1:"Maryland", fit1s:90.0, fit2:"Michigan", fit2s:88.0, fit3:"St. John's", fit3s:86.0, ppg:16.3, rpg:2.6, apg:2.8, best:"OUA 1st Team All-Star (2024-25); TMU Bold; backcourt partner to Kone; playmaking guard", fgp:35.4, tpp:25.3, ftp:77.9, spg:2.0, bpg:0.0, tov:3.0, mpg:32.1, gp:24, gs:24, hometown:"Hamilton", province:"ON", major:null, injury:null, verified:true, awards:["⭐ OUA 1st Team All-Star (2024-25)"], season:"2025-26", needsUpdate:false },

  { rank:7, name:"Tayler Scott", team:"McMaster", year:"Y1", pos:"Forward", ht:'5\'11"', wt:null, sys:"Motion Offense", pace:72.0, sos:0.9, stat:55.4, fit:58.0, elig:20, demand:27.2, ctx:78, ns:63.6, fit1:"Dayton", fit1s:88.0, fit2:"Villanova", fit2s:86.0, fit3:"Creighton", fit3s:84.0, ppg:14.2, rpg:9.8, apg:1.0, best:"U SPORTS All-Rookie Team (2025-26); McMaster forward from Burlington, ON; physical rebounder", fgp:48.8, tpp:0.0, ftp:61.0, spg:1.4, bpg:1.6, tov:2.5, mpg:25.5, gp:22, gs:19, hometown:"Burlington", province:"ON", major:"Humanities", injury:null, verified:true, awards:["⭐ U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:8, name:"Avery Geddes", team:"Victoria", year:"Y1", pos:"Guard", ht:'5\'8"', wt:null, sys:"Transition", pace:82.0, sos:0.85, stat:36.9, fit:55.0, elig:20, demand:47.9, ctx:73, ns:61.5, fit1:"Gonzaga", fit1s:88.0, fit2:"Gonzaga", fit2s:86.0, fit3:"Boise State", fit3s:84.0, ppg:9.9, rpg:3.5, apg:3.7, best:"ROY nominee (2025-26, Y1) — Victoria", fgp:31.6, tpp:23.3, ftp:72.1, spg:1.3, bpg:0.1, tov:3.0, mpg:35.0, gp:21, gs:21, hometown:"Victoria", province:"BC", major:null, injury:null, verified:true, awards:["🌟 U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:9, name:"Brooke Hussey", team:"Queen's", year:"Y2", pos:"Guard", ht:'5\'7"', wt:null, sys:"Motion Offense", pace:72.0, sos:1.0, stat:33.9, fit:60.0, elig:16, demand:47.9, ctx:78, ns:61.4, fit1:"Villanova", fit1s:88.0, fit2:"Dayton", fit2s:86.0, fit3:"Richmond", fit3s:84.0, ppg:8.0, rpg:2.9, apg:2.5, best:"OUA Rookie of the Year (2024-25); Queen's Gaels; immediate starter as a freshman", fgp:44.2, tpp:27.9, ftp:80.0, spg:1.6, bpg:0.2, tov:2.1, mpg:23.4, gp:21, gs:20, hometown:null, province:null, major:null, injury:null, verified:true, awards:["🏆 OUA Rookie of the Year (2024-25)"], season:"2025-26", needsUpdate:false },

  { rank:10, name:"Cairo Henning", team:"Dalhousie", year:"Y1", pos:"Guard", ht:'5\'9"', wt:null, sys:"Motion Offense", pace:76.0, sos:0.75, stat:40.5, fit:52.0, elig:20, demand:47.9, ctx:78, ns:60.8, fit1:"Vermont", fit1s:86.0, fit2:"Maine", fit2s:84.0, fit3:"Buffalo", fit3s:82.0, ppg:10.2, rpg:5.0, apg:3.9, best:"ROY nominee (2025-26, Y1) — Dalhousie", fgp:24.3, tpp:20.6, ftp:66.7, spg:2.2, bpg:0.1, tov:3.4, mpg:34.6, gp:20, gs:20, hometown:"Montreal", province:"QC", major:null, injury:null, verified:true, awards:["🌟 U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:11, name:"Jeannette Umuhoza", team:"Concordia", year:"Y1", pos:"Guard", ht:'5\'10"', wt:null, sys:"Pick & Roll", pace:71.0, sos:0.90, stat:26.8, fit:58.0, elig:20, demand:47.9, ctx:92, ns:60.2, fit1:"Maryland", fit1s:88.0, fit2:"St. John's", fit2s:86.0, fit3:"Syracuse", fit3s:84.0, ppg:7.6, rpg:2.8, apg:1.2, best:"ROY nominee (2025-26, Y1) — Concordia", fgp:35.0, tpp:26.5, ftp:71.4, spg:0.7, bpg:0.3, tov:3.3, mpg:24.0, gp:16, gs:10, hometown:null, province:null, major:null, injury:null, verified:true, awards:["🌟 U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:12, name:"Maya Flindall", team:"Saskatchewan", year:"Y4", pos:"Guard", ht:'5\'10"', wt:null, sys:"Transition", pace:80.0, sos:0.85, stat:41.3, fit:58.0, elig:8, demand:47.9, ctx:73, ns:60.2, fit1:"Gonzaga", fit1s:90.0, fit2:"Boise State", fit2s:88.0, fit3:"Iowa State", fit3s:85.0, ppg:14.9, rpg:3.0, apg:1.6, best:"17 PTS in gold medal game (2025-26) — 2× National Champion; Saskatchewan 30-1", fgp:46.0, tpp:36.8, ftp:75.6, spg:1.4, bpg:0.2, tov:1.9, mpg:27.9, gp:25, gs:25, hometown:"St. Albert", province:"AB", major:null, injury:null, verified:true, awards:["🏆 U SPORTS National Champion (2025-26)", "🏆 U SPORTS National Champion (2024-25)"], season:"2025-26", needsUpdate:false },

  { rank:13, name:"Shannon Neita", team:"StFX", year:"Y3", pos:"Forward", ht:'5\'11"', wt:null, sys:"Motion Offense", pace:78.0, sos:0.75, stat:56.2, fit:52.0, elig:12, demand:27.2, ctx:78, ns:59.8, fit1:"Vermont", fit1s:84.0, fit2:"Buffalo", fit2s:82.0, fit3:"Maine", fit3s:80.0, ppg:12.4, rpg:10.1, apg:2.2, best:"DPOY nominee (2025-26) — StFX", fgp:46.2, tpp:11.1, ftp:68.4, spg:3.8, bpg:0.6, tov:2.4, mpg:29.9, gp:20, gs:20, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },

  { rank:14, name:"Ava Stranges", team:"Brock", year:"Y2", pos:"Guard", ht:'5\'9"', wt:null, sys:"Isolation / P&R", pace:74.0, sos:0.9, stat:33.6, fit:58.0, elig:16, demand:47.9, ctx:73, ns:59.7, fit1:"Indiana", fit1s:86.0, fit2:"Syracuse", fit2s:84.0, fit3:"Louisville", fit3s:82.0, ppg:8.5, rpg:3.8, apg:2.7, best:"Career-high 25 pts in OUA QF (2025-26); emerging scorer alongside Weinert at Brock; 7 RPG in QF", fgp:31.4, tpp:27.7, ftp:59.0, spg:1.2, bpg:0.3, tov:2.7, mpg:33.5, gp:24, gs:24, hometown:null, province:null, major:null, injury:null, verified:true, awards:[], season:"2025-26", needsUpdate:false },

  { rank:15, name:"Logan Reider", team:"Saskatchewan", year:"Y4", pos:"Guard", ht:'5\'9"', wt:null, sys:"Transition", pace:80.0, sos:0.85, stat:38.0, fit:60.0, elig:8, demand:47.9, ctx:73, ns:59.6, fit1:"Gonzaga", fit1s:92.0, fit2:"Boise State", fit2s:90.0, fit3:"Boise State", fit3s:87.0, ppg:13.5, rpg:2.2, apg:2.1, best:"19 PTS in gold medal game (2025-26) — 26 PTS / 16 REB in semifinal vs Laval; 2× National Champion; Saskatchewan 30-1", fgp:42.5, tpp:33.3, ftp:79.2, spg:1.0, bpg:0.2, tov:1.6, mpg:23.7, gp:21, gs:10, hometown:"Saskatoon", province:"SK", major:null, injury:null, verified:true, awards:["🏆 U SPORTS National Champion (2025-26)", "🏅 Final 8 Championship All-Star (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:16, name:"Enora Touloute", team:"Ottawa", year:"Y3", pos:"Guard", ht:'5\'7"', wt:null, sys:"Halfcourt", pace:70.0, sos:1.0, stat:35.1, fit:56.0, elig:12, demand:47.9, ctx:73, ns:59.2, fit1:"Georgetown", fit1s:85.0, fit2:"Providence", fit2s:83.0, fit3:"Saint Joseph's", fit3s:80.0, ppg:5.4, rpg:5.0, apg:1.5, best:"OUA Champion of EDI Award (2025-26); Ottawa Gee-Gees; community leader; Y3 guard from Ottawa", fgp:44.6, tpp:0.0, ftp:29.4, spg:2.5, bpg:0.7, tov:1.5, mpg:20.8, gp:19, gs:19, hometown:"Ottawa", province:"ON", major:null, injury:null, verified:true, awards:["🏅 OUA Champion of EDI Award (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:17, name:"Emilia Diaz-Ruiz", team:"McGill", year:"Y2", pos:"Forward", ht:'6\'0"', wt:null, sys:"Pick & Roll", pace:71.0, sos:0.90, stat:41.3, fit:55.0, elig:16, demand:27.2, ctx:92, ns:59.0, fit1:"St. John's", fit1s:88.0, fit2:"Marquette", fit2s:86.0, fit3:"Syracuse", fit3s:84.0, ppg:10.4, rpg:7.8, apg:1.4, best:"11.1 PPG / 7.8 RPG (2025-26, Y2) — Sylvia Sweeney Award (community service); RSEQ Champion McGill; 4 double-doubles; 18 REB vs UQAM; Chemical Engineering student, 3.82 GPA", fgp:45.0, tpp:0.0, ftp:75.8, spg:1.2, bpg:0.4, tov:2.1, mpg:21.0, gp:26, gs:13, hometown:"Hamilton", province:"ON", major:"Chemical Engineering", injury:null, verified:true, awards:["🏆 Sylvia Sweeney Award — Community Service (2025-26)", "🏆 RSEQ Champion (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:18, name:"Cassidy Buchanan", team:"Trinity Western", year:"Y4", pos:"Guard", ht:'5\'8"', wt:null, sys:"Motion Offense", pace:72.0, sos:0.75, stat:42.5, fit:58.0, elig:8, demand:47.9, ctx:73, ns:58.6, fit1:"Gonzaga", fit1s:88.0, fit2:"Santa Clara", fit2s:85.0, fit3:"San Diego State", fit3s:82.0, ppg:12.5, rpg:4.0, apg:2.3, best:"CW 2nd Team All-Star (2025-26); Trinity Western leader; 4th year guard from Aldergrove, BC", fgp:44.2, tpp:28.2, ftp:80.5, spg:1.5, bpg:0.5, tov:3.0, mpg:25.7, gp:22, gs:22, hometown:"Aldergrove", province:"BC", major:null, injury:null, verified:true, awards:["⭐ CW 2nd Team All-Star (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:19, name:"Ella Murphy Wiebe", team:"Saskatchewan", year:"Y4", pos:"Forward", ht:'6\'1"', wt:null, sys:"Transition", pace:80.0, sos:0.85, stat:47.3, fit:55.0, elig:8, demand:27.2, ctx:73, ns:57.5, fit1:"Gonzaga", fit1s:88.0, fit2:"Gonzaga", fit2s:86.0, fit3:"Iowa State", fit3s:84.0, ppg:12.1, rpg:7.5, apg:1.6, best:"Final 8 MVP (2025-26) — led tournament in offensive reb (15); 13 PTS / 10 REB in gold medal game; 2× National Champion (2025, 2026); Saskatchewan 30-1", fgp:54.1, tpp:50.0, ftp:75.6, spg:1.8, bpg:0.5, tov:2.1, mpg:23.0, gp:21, gs:21, hometown:"Saskatoon", province:"SK", major:null, injury:null, verified:true, awards:["🏆 U SPORTS National Champion (2025-26)", "🏅 Final 8 MVP (2025-26)", "🏆 U SPORTS National Champion (2024-25)"], season:"2025-26", needsUpdate:false },

  { rank:20, name:"Ingrid Khuong", team:"UPEI", year:"Y1", pos:"Forward", ht:'5\'7"', wt:null, sys:"Pick & Roll", pace:70.0, sos:0.75, stat:42.7, fit:55.0, elig:20, demand:27.2, ctx:73, ns:56.9, fit1:"Vermont", fit1s:85.0, fit2:"Maine", fit2s:83.0, fit3:"Bryant", fit3s:80.0, ppg:4.3, rpg:9.3, apg:2.5, best:"U SPORTS All-Rookie Team (2025-26); UPEI; Quebec City native; Sustainable Design Engineering major", fgp:33.3, tpp:0.0, ftp:63.6, spg:2.0, bpg:1.5, tov:2.0, mpg:23.6, gp:20, gs:20, hometown:"Quebec City", province:"QC", major:"Sustainable Design Engineering", injury:null, verified:true, awards:["⭐ U SPORTS All-Rookie Team (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:21, name:"Addie Mombourquette", team:"UNB", year:"Y2", pos:"Guard", ht:'5\'7"', wt:null, sys:"Halfcourt", pace:68.0, sos:0.85, stat:26.8, fit:56.0, elig:16, demand:47.9, ctx:73, ns:56.0, fit1:"Vermont", fit1s:86.0, fit2:"Maine", fit2s:84.0, fit3:"Albany", fit3s:82.0, ppg:7.0, rpg:3.2, apg:1.5, best:"AUS Rookie of the Year (2024-25); UNB; 10.8 PPG as freshman; 87.7% FT (#1 U SPORTS); Fredericton native", fgp:33.3, tpp:21.7, ftp:59.0, spg:0.4, bpg:0.4, tov:2.5, mpg:21.1, gp:11, gs:11, hometown:"Fredericton", province:"NB", major:null, injury:null, verified:true, awards:["🏆 AUS Rookie of the Year (2024-25)"], season:"2025-26", needsUpdate:false },

  { rank:22, name:"Maheva Ngassam", team:"UNB", year:"Y3", pos:"Forward", ht:'6\'0"', wt:null, sys:"Motion Offense", pace:76.0, sos:0.75, stat:36.6, fit:52.0, elig:12, demand:27.2, ctx:78, ns:53.7, fit1:"Vermont", fit1s:85.0, fit2:"Maine", fit2s:83.0, fit3:"Buffalo", fit3s:81.0, ppg:8.2, rpg:7.1, apg:1.3, best:"10 PTS in national gold medal game (2025-26) — AUS Champion UNB; national silver medallist", fgp:48.6, tpp:0.0, ftp:52.9, spg:1.4, bpg:0.1, tov:3.5, mpg:22.0, gp:20, gs:20, hometown:null, province:null, major:null, injury:null, verified:true, awards:["🥈 U SPORTS National Silver Medal (2025-26)"], season:"2025-26", needsUpdate:false },

  { rank:23, name:"Melina Collins", team:"Dalhousie", year:"Y3", pos:"Forward", ht:'5\'11"', wt:null, sys:"Transition", pace:72.0, sos:0.85, stat:27.3, fit:55.0, elig:12, demand:27.2, ctx:73, ns:51.6, fit1:"Vermont", fit1s:84.0, fit2:"Maine", fit2s:82.0, fit3:"Bucknell", fit3s:80.0, ppg:8.2, rpg:3.6, apg:1.1, best:"AUS Student-Athlete Community Service Award (2025-26); Dalhousie; solid two-way forward", fgp:23.9, tpp:31.2, ftp:75.0, spg:1.3, bpg:0.2, tov:2.5, mpg:26.4, gp:20, gs:20, hometown:null, province:null, major:null, injury:null, verified:true, awards:["🏅 AUS Community Service Award (2025-26)"], season:"2025-26", needsUpdate:false },
...
const GLOSSARY_ITEMS = [
  ...
  { term:"Open Slots",
    ...
    section:"Metrics" },
  { term:"Pipeline",
    def:"Boreal's recruiter tracking tool. Set a player's STATUS on their card (Watchlist → Shortlisted → Contacted → Offer Out → Verbal → Signed) and they automatically appear in the Pipeline tab. Per-player recruiting checklists, scout notes, and an activity log persist across sessions.\n\nThe Pipeline tab also archives Past Transfers — U SPORTS players who have already made the jump to NCAA D1, including Nginyu Ngala (Laurentian → Kansas), Noah Otshudi (Western → Marshall), Xavier Spencer (Carleton → UMass Lowell), Lennart Weber (Toronto → Bryant), and Javier Gilgeous-Alexander (TMU → Troy).",
    section:"Metrics" }];
...
// Sources: Warren Nolan 2025-26 (ORtg/DRtg/Net/Pace), Warren Nolan NET page (NET rank, W/L)
// Coach, tenure, CA history, slots, position needs: TBD (manual research)
// Portal window: April 6–20, 2026 (WBB)

const NCAA_SCHOOLS_W = [
  // Big East
  { name:"UConn",            conf:"BE",   w:34, l:0,  net:+50.8, ortg:119.2, drtg:68.4,  adjt:73.9, pace:"Fast",     sys:"Motion Offense", tier:1, ca:1, kp:1,   slots:2, coach:"Geno Auriemma",     tenure:41, pos:[8,5,2], need:[1,1,0] },
  { name:"Marquette",        conf:"BE",   w:17, l:12, net:+6.0,  ortg:98.3,  drtg:92.3,  adjt:70.0, pace:"Medium",   sys:"Motion Offense", tier:1, ca:2, kp:66,  slots:4, coach:"Cara Consuegra",               tenure:3, pos:[7,4,2], need:[2,1,1] },
  { name:"Villanova",        conf:"BE",   w:25, l:7,  net:+16.8, ortg:101.9, drtg:85.1,  adjt:71.4, pace:"Medium",   sys:"Motion Offense", tier:1, ca:2, kp:35,  slots:3, coach:"Denise Dillon",               tenure:4, pos:[8,4,1], need:[1,1,1] },
  { name:"St. John's",       conf:"BE",   w:22, l:11, net:+2.1,  ortg:92.8,  drtg:90.7,  adjt:69.0, pace:"Slow",     sys:"Iso / P&R", tier:1, ca:0, kp:100, slots:4, coach:"Joe Tartamella",               tenure:11, pos:[7,4,2], need:[2,1,1] },
  { name:"Creighton",        conf:"BE",   w:16, l:15, net:+0.8,  ortg:96.6,  drtg:95.8,  adjt:70.3, pace:"Medium",   sys:"Motion Offense", tier:1, ca:0, kp:90,  slots:4, coach:"Jim Flanery",               tenure:24, pos:[8,3,2], need:[2,1,1] },
  { name:"Georgetown",       conf:"BE",   w:14, l:17, net:+2.3,  ortg:92.8,  drtg:90.5,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:1, ca:0, kp:95,  slots:5, coach:"Darnell Haney",               tenure:2, pos:[7,4,2], need:[3,1,1] },
  { name:"Providence",       conf:"BE",   w:15, l:18, net:-6.5,  ortg:85.6,  drtg:92.1,  adjt:69.3, pace:"Slow",     sys:"Halfcourt", tier:1, ca:0, kp:148, slots:5, coach:"Erin Batth",               tenure:2, pos:[7,4,2], need:[3,1,1] },
  { name:"DePaul",           conf:"BE",   w:16, l:16, net:-12.7, ortg:86.6,  drtg:99.3,  adjt:72.9, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:2, kp:210,slots:5, coach:"Michele Pizzotti",               tenure:2, pos:[7,4,2], need:[3,1,1] },
  { name:"Seton Hall",       conf:"BE",   w:19, l:12, net:+6.6,  ortg:96.8,  drtg:90.2,  adjt:70.0, pace:"Medium",   sys:"Motion Offense", tier:1, ca:0, kp:65,  slots:4, coach:"Tony Bozzella",               tenure:11, pos:[8,4,1], need:[2,1,1] },
  // Big Ten
  { name:"Michigan",         conf:"B10",  w:25, l:6,  net:+28.2, ortg:110.9, drtg:82.7,  adjt:75.2, pace:"Fast",     sys:"Transition", tier:1, ca:1, kp:6,   slots:3, coach:"Kim Barnes Arico",               tenure:14, pos:[8,4,2], need:[1,1,1] },
  { name:"Michigan State",   conf:"B10",  w:22, l:8,  net:+23.4, ortg:113.0, drtg:89.6,  adjt:73.5, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:1, kp:17,  slots:3, coach:"Robyn Fralick",               tenure:2, pos:[7,4,2], need:[1,1,1] },
  { name:"Maryland",         conf:"B10",  w:23, l:8,  net:+25.3, ortg:110.3, drtg:85.0,  adjt:73.5, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:0, kp:14,  slots:4, coach:"Brenda Frese",               tenure:24, pos:[8,4,2], need:[2,1,1] },
  { name:"Indiana",          conf:"B10",  w:18, l:14, net:+3.1,  ortg:101.8, drtg:98.7,  adjt:70.5, pace:"Medium",   sys:"Motion Offense", tier:1, ca:0, kp:55,  slots:5, coach:"Teri Moren",               tenure:11, pos:[7,4,2], need:[3,1,1] },
  { name:"Ohio State",       conf:"B10",  w:26, l:7,  net:+21.0, ortg:107.4, drtg:86.4,  adjt:76.3, pace:"Fast",     sys:"Transition", tier:1, ca:1, kp:15,  slots:3, coach:"Kevin McGuff",               tenure:13, pos:[8,4,2], need:[1,1,1] },
  { name:"Minnesota",        conf:"B10",  w:22, l:8,  net:+25.9, ortg:110.2, drtg:84.3,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:1, ca:0, kp:9,   slots:3, coach:"Dawn Plitzuweit",               tenure:3, pos:[8,4,1], need:[1,1,1] },
  { name:"Rutgers",          conf:"B10",  w:9,  l:20, net:-16.7, ortg:84.1,  drtg:100.8, adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:1, ca:0, kp:170, slots:8, coach:"Gary Redus II",               tenure:0, pos:[6,4,2], need:[4,2,2] },
  { name:"Illinois",         conf:"B10",  w:21, l:11, net:+17.0, ortg:109.0, drtg:92.0,  adjt:71.7, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:1, kp:30,  slots:4, coach:"Shauna Green",               tenure:4, pos:[7,4,2], need:[2,1,1] },
  // ACC
  { name:"Louisville",       conf:"ACC",  w:27, l:7,  net:+26.8, ortg:110.4, drtg:83.6,  adjt:72.0, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:0, kp:11,  slots:3, coach:"Jeff Walz",               tenure:19, pos:[7,4,2], need:[1,1,1] },
  { name:"Syracuse",         conf:"ACC",  w:23, l:8,  net:+15.8, ortg:101.8, drtg:86.0,  adjt:72.3, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:0, kp:39,  slots:4, coach:"Felisha Legette-Jack",               tenure:4, pos:[7,4,2], need:[2,1,1] },
  { name:"Virginia Tech",    conf:"ACC",  w:23, l:9,  net:+16.3, ortg:99.5,  drtg:83.2,  adjt:73.2, pace:"Med-Fast", sys:"Half & Half", tier:1, ca:0, kp:41,  slots:4, coach:"Megan Duffy",               tenure:1, pos:[7,4,2], need:[2,1,1] },
  { name:"Duke",             conf:"ACC",  w:24, l:8,  net:+21.1, ortg:102.9, drtg:81.8,  adjt:72.3, pace:"Med-Fast", sys:"Motion Offense", tier:1, ca:2, kp:8,   slots:3, coach:"Kara Lawson",               tenure:6, pos:[8,4,2], need:[1,1,1] },
  { name:"North Carolina",   conf:"ACC",  w:26, l:7,  net:+23.9, ortg:106.5, drtg:82.6,  adjt:70.1, pace:"Medium",   sys:"Motion Offense", tier:1, ca:0, kp:19,  slots:3, coach:"Courtney Banghart",               tenure:7, pos:[7,4,2], need:[1,1,1] },
  { name:"Pittsburgh",       conf:"ACC",  w:14, l:17, net:-17.9, ortg:84.1,  drtg:102.0, adjt:71.9, pace:"Med-Fast", sys:"Halfcourt", tier:1, ca:5, kp:245,slots:7, coach:"Vacant (Verdi fired)",               tenure:0, pos:[6,4,2], need:[4,2,1] },
  // SEC
  { name:"South Carolina",   conf:"SEC",  w:31, l:3,  net:+40.1, ortg:117.7, drtg:77.6,  adjt:73.7, pace:"Med-Fast", sys:"Transition", tier:1, ca:1, kp:3,   slots:2, coach:"Dawn Staley",       tenure:17, pos:[8,4,2], need:[1,1,0] },
  { name:"Tennessee",        conf:"SEC",  w:16, l:13, net:+10.1, ortg:101.5, drtg:91.4,  adjt:75.9, pace:"Fast",     sys:"Transition", tier:1, ca:1, kp:23,  slots:4, coach:"Kim Caldwell",               tenure:2, pos:[7,5,2], need:[2,1,1] },
  { name:"Ole Miss",         conf:"SEC",  w:23, l:11, net:+18.4, ortg:104.8, drtg:86.4,  adjt:71.6, pace:"Med-Fast", sys:"Iso / P&R", tier:1, ca:1, kp:20,  slots:4, coach:"Yolett McPhee-McCuin",               tenure:8, pos:[7,4,2], need:[2,1,1] },
  { name:"Vanderbilt",       conf:"SEC",  w:27, l:4,  net:+26.4, ortg:115.5, drtg:89.1,  adjt:73.6, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:0, kp:7,   slots:3, coach:"Shea Ralph",               tenure:5, pos:[8,4,1], need:[1,1,1] },
  { name:"Kentucky",         conf:"SEC",  w:23, l:10, net:+20.6, ortg:107.5, drtg:86.9,  adjt:70.3, pace:"Medium",   sys:"Motion Offense", tier:1, ca:0, kp:16,  slots:4, coach:"Kenny Brooks",               tenure:2, pos:[7,4,2], need:[2,1,1] },
  // Big 12
  { name:"West Virginia",    conf:"B12",  w:27, l:6,  net:+25.4, ortg:105.6, drtg:80.2,  adjt:72.7, pace:"Med-Fast", sys:"Halfcourt", tier:1, ca:0, kp:18,  slots:3, coach:"Mark Kellogg",               tenure:2, pos:[7,4,2], need:[1,1,1] },
  { name:"TCU",              conf:"B12",  w:29, l:5,  net:+31.6, ortg:110.5, drtg:78.9,  adjt:70.7, pace:"Medium",   sys:"Pick & Roll", tier:1, ca:0, kp:12,  slots:4, coach:"Mark Campbell",               tenure:3, pos:[7,4,2], need:[2,1,1] },
  { name:"Baylor",           conf:"B12",  w:24, l:8,  net:+16.1, ortg:99.4,  drtg:83.3,  adjt:72.2, pace:"Med-Fast", sys:"Pick & Roll", tier:1, ca:1, kp:32,  slots:3, coach:"Nicki Collen",               tenure:5, pos:[7,4,2], need:[1,1,1] },
  { name:"Iowa State",       conf:"B12",  w:22, l:9,  net:+21.0, ortg:112.6, drtg:91.6,  adjt:73.7, pace:"Med-Fast", sys:"Iso / P&R", tier:1, ca:0, kp:33,  slots:3, coach:"Bill Fennelly",               tenure:31, pos:[7,4,2], need:[1,1,1] },
  { name:"Cincinnati",       conf:"B12",  w:10, l:20, net:-7.2,  ortg:94.5,  drtg:101.7, adjt:72.7, pace:"Med-Fast", sys:"Halfcourt", tier:1, ca:1, kp:109, slots:5, coach:"Katrina Merriweather",               tenure:4, pos:[7,4,2], need:[3,1,1] },
  // WCC
  { name:"Gonzaga",          conf:"WCC",  w:24, l:9,  net:+12.3, ortg:103.3, drtg:91.0,  adjt:70.3, pace:"Medium",   sys:"Motion Offense", tier:2, ca:0, kp:61,  slots:4, coach:"Lisa Fortier",               tenure:10, pos:[7,4,2], need:[2,1,1] },
  { name:"Santa Clara",      conf:"WCC",  w:22, l:9,  net:+12.6, ortg:103.5, drtg:90.9,  adjt:75.9, pace:"Fast",     sys:"Transition", tier:2, ca:0, kp:81,  slots:4, coach:"Bill Carr",               tenure:4, pos:[7,4,2], need:[2,1,1] },
  // A10
  { name:"Dayton",           conf:"A10",  w:17, l:14, net:-0.9,  ortg:94.3,  drtg:95.2,  adjt:70.3, pace:"Medium",   sys:"Motion Offense", tier:2, ca:4, kp:167, slots:4, coach:"Tamika Williams-Jeter",               tenure:3, pos:[7,4,2], need:[2,1,1] },
  { name:"VCU",              conf:"A10",  w:14, l:16, net:-14.2, ortg:80.8,  drtg:95.0,  adjt:70.4, pace:"Medium",   sys:"Halfcourt", tier:2, ca:2, kp:230,slots:7, coach:"Vacant (O'Boyle fired)",               tenure:0, pos:[6,4,2], need:[4,2,1] },
  { name:"Richmond",         conf:"A10",  w:26, l:7,  net:+21.7, ortg:108.6, drtg:86.9,  adjt:69.0, pace:"Slow",     sys:"Motion Offense", tier:2, ca:0, kp:37,  slots:3, coach:"Aaron Roussell",               tenure:8, pos:[7,4,2], need:[1,1,1] },
  { name:"Saint Joseph's",   conf:"A10",  w:18, l:11, net:+8.8,  ortg:97.7,  drtg:88.9,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:2, ca:0, kp:86,  slots:4, coach:"Cindy Griffin",               tenure:14, pos:[7,4,2], need:[2,1,1] },
  // MAC
  { name:"Buffalo",          conf:"MAC",  w:3,  l:27, net:-16.7, ortg:80.0,  drtg:96.7,  adjt:73.6, pace:"Med-Fast", sys:"Transition", tier:3, ca:1, kp:320,slots:6, coach:"Scott Hemer",               tenure:1, pos:[6,4,2], need:[3,2,1] },
  { name:"Akron",            conf:"MAC",  w:5,  l:24, net:-17.0, ortg:87.9,  drtg:104.9, adjt:74.6, pace:"Fast",     sys:"Transition", tier:3, ca:1, kp:292, slots:5, coach:"Melissa Jackson",               tenure:3, pos:[7,4,2], need:[3,1,1] },
  { name:"Miami (OH)",       conf:"MAC",  w:25, l:6,  net:+15.1, ortg:99.3,  drtg:84.2,  adjt:70.6, pace:"Medium",   sys:"Motion Offense", tier:2, ca:0, kp:75,  slots:3, coach:"Glenn Box",               tenure:3, pos:[8,4,2], need:[1,1,1] },
  { name:"Ball State",       conf:"MAC",  w:25, l:7,  net:+15.6, ortg:103.1, drtg:87.5,  adjt:75.8, pace:"Fast",     sys:"Transition", tier:2, ca:0, kp:68,  slots:3, coach:"Brady Sallee",               tenure:15, pos:[8,4,1], need:[1,1,1] },
  { name:"Bowling Green",    conf:"MAC",  w:13, l:14, net:-4.7,  ortg:87.8,  drtg:92.5,  adjt:73.3, pace:"Med-Fast", sys:"Half & Half", tier:3, ca:1, kp:189, slots:5, coach:"Fred Chmiel",               tenure:1, pos:[7,4,2], need:[3,1,1] },
  // America East
  { name:"Vermont",          conf:"AE",   w:25, l:7,  net:+17.7, ortg:101.0, drtg:83.3,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:2, ca:2, kp:80,  slots:3, coach:"Alisa Kresge",               tenure:14, pos:[7,4,2], need:[1,1,1] },
  { name:"Maine",            conf:"AE",   w:19, l:13, net:+3.4,  ortg:93.5,  drtg:90.1,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:3, ca:0, kp:146, slots:4, coach:"Amy Vachon",               tenure:7, pos:[7,4,2], need:[2,1,1] },
  { name:"UMass Lowell",     conf:"AE",   w:15, l:18, net:-25.5, ortg:80.2,  drtg:105.7, adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:3, ca:1, kp:290,slots:5, coach:"Jenerrie Harris",               tenure:3, pos:[7,4,1], need:[3,1,1] },
  { name:"Albany",           conf:"AE",   w:11, l:21, net:+1.3,  ortg:91.9,  drtg:90.6,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:3, ca:1, kp:260,slots:5, coach:"Colleen Mullen",               tenure:12, pos:[7,4,2], need:[3,1,1] },
  // MWC
  { name:"Boise State",      conf:"MWC",  w:24, l:9,  net:+9.4,  ortg:98.8,  drtg:89.4,  adjt:71.7, pace:"Med-Fast", sys:"Pick & Roll", tier:2, ca:1, kp:122, slots:3, coach:"Gordy Presnell",               tenure:18, pos:[7,4,2], need:[1,1,1] },
  { name:"San Diego State",  conf:"MWC",  w:24, l:5,  net:+13.9, ortg:100.8, drtg:86.9,  adjt:68.5, pace:"Slow",     sys:"Halfcourt", tier:2, ca:0, kp:72,  slots:3, coach:"Stacie Terry-Hutson",               tenure:4, pos:[7,4,2], need:[1,1,1] },
  { name:"Colorado State",   conf:"MWC",  w:26, l:7,  net:+16.2, ortg:100.1, drtg:83.9,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:2, ca:0, kp:70,  slots:3, coach:"Ryun Williams",               tenure:13, pos:[7,4,2], need:[1,1,1] },
  // Patriot League
  { name:"Army",             conf:"PL",   w:23, l:7,  net:+14.3, ortg:98.9,  drtg:84.6,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:3, ca:0, kp:123, slots:3, coach:"Missy Traversi",               tenure:4, pos:[7,4,2], need:[1,1,1] },
  { name:"Bucknell",         conf:"PL",   w:10, l:23, net:-11.3, ortg:80.8,  drtg:92.1,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:3, ca:0, kp:255,slots:5, coach:"Aaron Haar",               tenure:5, pos:[7,4,2], need:[3,1,1] },
  // Other
  { name:"Bryant",           conf:"AE",   w:16, l:12, net:+8.6,  ortg:92.0,  drtg:83.4,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:3, ca:0, kp:164, slots:4, coach:"Mary Burke",               tenure:14, pos:[7,4,2], need:[2,1,1] },
  { name:"Quinnipiac",       conf:"MAAC", w:26, l:6,  net:+26.9, ortg:104.3, drtg:77.4,  adjt:69.0, pace:"Slow",     sys:"Halfcourt", tier:2, ca:0, kp:84,  slots:3, coach:"Tricia Fabbri",               tenure:30, pos:[7,4,2], need:[1,1,1] },
];

// ─── NCAA TARGET SCHOOLS (MEN'S) ──────────────────────────────────────────────

const NCAA_SCHOOLS = [
  { name:"Illinois",         conf:"B10",  w:22, l:13, net:+24.32, ortg:121.9, drtg:97.6,  adjt:71.5, pace:"Fast",     sys:"Motion Offense",  tier:1, ca:6, kp:17,  slots:3, coach:"Shauna Green",   tenure:4,  pos:[7,4,2], need:[2,2,1] },
  { name:"Michigan",         conf:"B10",  w:27, l:10, net:+23.45, ortg:116.5, drtg:93.1,  adjt:70.1, pace:"Fast",     sys:"Pick & Roll",     tier:1, ca:8, kp:21,  slots:4, coach:"Kim Barnes Arico",         tenure:14,  pos:[9,4,2], need:[4,1,0] },
  { name:"St. John's",       conf:"BE",   w:31, l:5,  net:+26.06, ortg:114.0, drtg:88.0,  adjt:70.0, pace:"Fast",     sys:"Iso / P&R",       tier:1, ca:5, kp:14,  slots:3, coach:"Joe Tartamella",       tenure:11,  pos:[8,6,0], need:[1,3,0] },
  { name:"Gonzaga",          conf:"WCC",  w:26, l:9,  net:+28.01, ortg:124.7, drtg:96.7,  adjt:70.5, pace:"Fast",     sys:"Motion Offense",  tier:1, ca:7, kp:8,   slots:3, coach:"Lisa Fortier",           tenure:10, pos:[7,5,1], need:[3,3,0] },
  { name:"Butler",           conf:"BE",   w:15, l:20, net:+10.54, ortg:117.2, drtg:106.7, adjt:68.0, pace:"Med-Fast", sys:"Motion Offense",  tier:1, ca:4, kp:75,  slots:5, coach:"Thad Matta",         tenure:4,  pos:[7,4,1], need:[3,1,0] },
  { name:"Memphis",          conf:"Amer", w:13, l:19, net:-2.40, ortg:113.4, drtg:98.3,  adjt:71.0, pace:"Fast",     sys:"Transition",      tier:1, ca:6, kp:54,  slots:5, coach:"Penny Hardaway",    tenure:8,  pos:[7,6,2], need:[4,2,1] },
  ...
  { name:"Missouri",         conf:"SEC",  w:25, l:10, net:+20.10, ortg:118.4, drtg:98.2,  adjt:70.2, pace:"Fast",     sys:"Pick & Roll",     tier:2, ca:6, kp:36,  slots:4, coach:"Dennis Gates",       tenure:4,  pos:[8,5,1], need:[3,2,0] },
  { name:"Boise State",      conf:"MWC",  w:26, l:10, net:+18.50, ortg:117.2, drtg:99.0,  adjt:70.8, pace:"Fast",     sys:"Transition",      tier:2, ca:5, kp:43,  slots:4, coach:"Gordy Presnell",          tenure:18, pos:[7,5,2], need:[3,2,1] },
  { name:"Pittsburgh",       conf:"ACC",  w:21, l:14, net:+14.20, ortg:114.8, drtg:100.6, adjt:69.8, pace:"Med-Fast", sys:"Motion Offense",  tier:2, ca:5, kp:52,  slots:4, coach:"Vacant (Verdi fired)",         tenure:0,  pos:[8,4,2], need:[3,2,1] },
  { name:"San Diego State",  conf:"MWC",  w:22, l:11, net:+16.40, ortg:109.8, drtg:93.6,  adjt:67.4, pace:"Slow",     sys:"Halfcourt",       tier:2, ca:5, kp:48,  slots:3, coach:"Stacie Terry-Hutson",     tenure:4,  pos:[8,4,2], need:[2,3,1] },
  { name:"South Carolina",   conf:"SEC",  w:18, l:15, net:+12.30, ortg:112.6, drtg:100.4, adjt:68.9, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:5, kp:63,  slots:5, coach:"Dawn Staley",      tenure:17,  pos:[8,4,2], need:[3,2,1] },
  { name:"Wake Forest",      conf:"ACC",  w:18, l:15, net:+9.60,  ortg:112.4, drtg:102.8, adjt:68.2, pace:"Fast",     sys:"Transition",      tier:2, ca:4, kp:81,  slots:4, coach:"Steve Forbes",       tenure:6,  pos:[7,5,2], need:[3,3,0] },
  { name:"Ole Miss",         conf:"SEC",  w:19, l:15, net:+11.80, ortg:113.2, drtg:101.5, adjt:69.1, pace:"Fast",     sys:"Transition",      tier:2, ca:4, kp:70,  slots:5, coach:"Yolett McPhee-McCuin",        tenure:8,  pos:[7,5,2], need:[4,2,1] },
  { name:"Nevada",           conf:"MWC",  w:20, l:14, net:+9.20,  ortg:111.4, drtg:102.2, adjt:69.5, pace:"Med-Fast", sys:"Pick & Roll",     tier:2, ca:4, kp:88,  slots:5, coach:"Steve Alford",       tenure:7,  pos:[7,4,3], need:[3,2,1] },
  { name:"Boston College",   conf:"ACC",  w:17, l:16, net:+8.40,  ortg:110.2, drtg:101.8, adjt:68.5, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:4, kp:89,  slots:5, coach:"TBD (Earl Grant fired Mar 2026)",         tenure:4,  pos:[7,4,3], need:[3,2,1] },
  ...
  { name:"South Florida",    conf:"Amer", w:13, l:19, net:-2.84,  ortg:103.6, drtg:106.5, adjt:68.5, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:3, kp:196, slots:5, coach:"Bryan Hodgson",     tenure:1,  pos:[7,4,1], need:[2,1,1] },
  { name:"Pacific",          conf:"WCC",  w:9,  l:24, net:-10.36, ortg:101.5, drtg:111.8, adjt:66.6, pace:"Medium",   sys:"Iso / P&R",       tier:2, ca:6, kp:284, slots:6, coach:"Dave Smart",        tenure:3,  pos:[7,2,2], need:[2,0,2] },
  { name:"Bucknell",         conf:"PL",   w:18, l:15, net:-3.20,  ortg:105.8, drtg:109.0, adjt:67.8, pace:"Med",      sys:"Motion Offense",  tier:2, ca:3, kp:215, slots:4, coach:"Aaron Haar",  tenure:5,  pos:[7,4,2], need:[3,2,1] },
  ...
  { name:"Buffalo",          conf:"MAC",  w:16, l:17, net:-4.32,  ortg:99.1,  drtg:103.4, adjt:72.7, pace:"Fast",     sys:"Transition",      tier:3, ca:9, kp:149, slots:4, coach:"Scott Hemer",  tenure:1,  pos:[9,2,1], need:[3,1,1] },
  { name:"Akron",            conf:"MAC",  w:28, l:7,  net:+6.47,  ortg:113.6, drtg:107.1, adjt:71.7, pace:"Fast",     sys:"Transition",      tier:3, ca:3, kp:100, slots:3, coach:"Melissa Jackson",         tenure:3,  pos:[7,4,1], need:[3,2,0] },
  { name:"Bowling Green",    conf:"MAC",  w:14, l:18, net:-10.68, ortg:99.2,  drtg:109.8, adjt:68.9, pace:"Med-Fast", sys:"Iso / P&R",       tier:3, ca:5, kp:289, slots:5, coach:"Fred Chmiel",         tenure:1,  pos:[8,2,2], need:[3,1,1] },
  { name:"Western Michigan", conf:"MAC",  w:12, l:20, net:-10.70, ortg:101.7, drtg:112.4, adjt:68.0, pace:"Med-Fast", sys:"Halfcourt",       tier:3, ca:4, kp:290, slots:5, coach:"TBD (Dwayne Stephens fired Mar 2026)",   tenure:5,  pos:[7,4,1], need:[4,3,0] },
  ...
  { name:"Vermont",          conf:"AE",   w:21, l:12, net:-6.32,  ortg:99.3,  drtg:105.6, adjt:62.6, pace:"Slow",     sys:"Motion Offense",  tier:3, ca:5, kp:242, slots:2, coach:"Alisa Kresge",        tenure:14, pos:[8,3,1], need:[3,1,1] },
  { name:"Maine",            conf:"AE",   w:20, l:14, net:-4.60,  ortg:100.1, drtg:104.7, adjt:66.2, pace:"Medium",   sys:"Halfcourt",       tier:3, ca:5, kp:219, slots:3, coach:"Amy Vachon",    tenure:7,  pos:[7,4,1], need:[3,1,0] },
  { name:"UMass Lowell",     conf:"AE",   w:17, l:15, net:-6.42,  ortg:108.7, drtg:115.1, adjt:68.8, pace:"Med-Fast", sys:"Iso / P&R",       tier:3, ca:4, kp:244, slots:4, coach:"Jenerrie Harris",      tenure:3, pos:[8,2,2], need:[4,1,1] },
  { name:"Albany",           conf:"AE",   w:17, l:16, net:-9.20,  ortg:103.3, drtg:112.5, adjt:67.7, pace:"Med-Fast", sys:"Halfcourt",       tier:3, ca:3, kp:275, slots:3, coach:"Colleen Mullen",   tenure:12,  pos:[8,3,1], need:[4,1,0] },
  { name:"Tennessee Tech",   conf:"OVC",  w:15, l:16, net:-0.80,  ortg:108.4, drtg:110.6, adjt:67.3, pace:"Med",      sys:"Motion / P&R",   tier:3, ca:2, kp:168, slots:4, coach:"TBD (John Pelphrey fired Mar 2026)",     tenure:3,  pos:[6,4,2], need:[3,1,1] },

  // ── BIG EAST EXPANSION ───────────────────────────────────────────────────
  { name:"UConn",            conf:"BE",   w:26, l:9,  net:+22.10, ortg:116.8, drtg:94.2,  adjt:71.2, pace:"Fast",     sys:"Motion Offense",  tier:1, ca:5, kp:5,   slots:3, coach:"Geno Auriemma",       tenure:41,  pos:[8,5,1], need:[2,2,0] },
  { name:"Creighton",        conf:"BE",   w:25, l:10, net:+18.40, ortg:118.6, drtg:100.2, adjt:70.4, pace:"Fast",     sys:"Motion Offense",  tier:1, ca:4, kp:22,  slots:4, coach:"Jim Flanery",   tenure:24, pos:[8,4,1], need:[3,2,0] },
  { name:"Marquette",        conf:"BE",   w:19, l:16, net:+12.30, ortg:113.4, drtg:101.0, adjt:69.8, pace:"Med-Fast", sys:"Iso / P&R",       tier:1, ca:4, kp:29,  slots:4, coach:"Cara Consuegra",      tenure:3,  pos:[8,5,1], need:[3,2,0] },
  { name:"Xavier",           conf:"BE",   w:21, l:12, net:+14.60, ortg:115.2, drtg:100.8, adjt:69.5, pace:"Fast",     sys:"Motion Offense",  tier:1, ca:4, kp:44,  slots:4, coach:"Richard Pitino",       tenure:1,  pos:[7,5,2], need:[3,2,1] },
  { name:"Villanova",        conf:"BE",   w:18, l:14, net:+11.20, ortg:114.8, drtg:103.6, adjt:68.8, pace:"Med-Fast", sys:"Motion Offense",  tier:1, ca:4, kp:50,  slots:4, coach:"Denise Dillon",      tenure:4,  pos:[7,4,2], need:[3,2,0] },
  { name:"Providence",       conf:"BE",   w:12, l:20, net:+4.20,  ortg:108.6, drtg:104.4, adjt:67.6, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:4, kp:60,  slots:5, coach:"Erin Batth",       tenure:2,  pos:[7,4,2], need:[3,2,1] },
  { name:"Seton Hall",       conf:"BE",   w:7,  l:24, net:-2.10,  ortg:104.2, drtg:106.8, adjt:67.0, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:4, kp:91,  slots:5, coach:"Tony Bozzella",  tenure:11,  pos:[8,4,1], need:[4,2,1] },
  { name:"Georgetown",       conf:"BE",   w:17, l:15, net:+5.80,  ortg:108.4, drtg:102.6, adjt:68.2, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:4, kp:88,  slots:5, coach:"Darnell Haney",         tenure:2,  pos:[8,4,2], need:[3,2,1] },
  { name:"DePaul",           conf:"BE",   w:14, l:18, net:+1.40,  ortg:106.8, drtg:105.4, adjt:67.8, pace:"Fast",     sys:"Transition",      tier:3, ca:3, kp:122, slots:5, coach:"Michele Pizzotti",    tenure:2,  pos:[7,3,2], need:[4,2,1] },

  // ── BIG TEN EXPANSION ────────────────────────────────────────────────────
  { name:"Indiana",          conf:"B10",  w:22, l:12, net:+18.60, ortg:115.4, drtg:97.2,  adjt:70.8, pace:"Med-Fast", sys:"Motion Offense",  tier:1, ca:5, kp:30,  slots:4, coach:"Teri Moren",      tenure:11,  pos:[8,4,2], need:[3,2,1] },
  { name:"Maryland",         conf:"B10",  w:23, l:11, net:+16.80, ortg:114.6, drtg:97.8,  adjt:70.2, pace:"Fast",     sys:"Iso / P&R",       tier:1, ca:5, kp:37,  slots:4, coach:"Brenda Frese",     tenure:24,  pos:[8,4,2], need:[3,2,1] },
  { name:"Rutgers",          conf:"B10",  w:16, l:16, net:+8.20,  ortg:108.2, drtg:100.4, adjt:68.4, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:5, kp:80,  slots:4, coach:"Gary Redus II",     tenure:0, pos:[8,3,2], need:[3,2,1] },

  // ── ACC EXPANSION ────────────────────────────────────────────────────────
  { name:"Syracuse",         conf:"ACC",  w:15, l:17, net:+11.60, ortg:112.8, drtg:101.2, adjt:68.6, pace:"Med-Fast", sys:"Motion Offense",  tier:2, ca:6, kp:72,  slots:4, coach:"Felisha Legette-Jack",      tenure:4,  pos:[7,4,2], need:[3,2,1] },
  { name:"Louisville",       conf:"ACC",  w:18, l:14, net:+10.40, ortg:111.6, drtg:101.4, adjt:68.2, pace:"Fast",     sys:"Transition",      tier:2, ca:4, kp:78,  slots:5, coach:"Jeff Walz",        tenure:19,  pos:[8,4,2], need:[4,2,1] },

  // ── SEC EXPANSION ────────────────────────────────────────────────────────
  { name:"Tennessee",        conf:"SEC",  w:27, l:9,  net:+22.40, ortg:116.0, drtg:93.8,  adjt:71.0, pace:"Med-Fast", sys:"Motion Offense",  tier:1, ca:4, kp:19,  slots:3, coach:"Kim Caldwell",       tenure:2, pos:[8,4,2], need:[2,2,1] },
  ...
  // ── BIG 12 EXPANSION ─────────────────────────────────────────────────────
  { name:"Cincinnati",       conf:"B12",  w:18, l:15, net:+13.60, ortg:112.4, drtg:98.8,  adjt:69.6, pace:"Med-Fast", sys:"Iso / P&R",       tier:2, ca:4, kp:58,  slots:4, coach:"Katrina Merriweather",        tenure:4,  pos:[8,4,2], need:[3,2,1] },
  { name:"West Virginia",    conf:"B12",  w:17, l:15, net:+8.80,  ortg:109.6, drtg:101.2, adjt:68.8, pace:"Fast",     sys:"Transition",      tier:2, ca:3, kp:81,  slots:4, coach:"Mark Kellogg",    tenure:2,  pos:[7,4,2], need:[3,2,1] },
  { name:"Kansas State",     conf:"B12",  w:24, l:11, net:+17.20, ortg:114.2, drtg:97.0,  adjt:70.2, pace:"Med-Fast", sys:"Pick & Roll",     tier:2, ca:4, kp:32,  slots:4, coach:"Casey Alexander",       tenure:0,  pos:[7,4,2], need:[3,2,1] },

  // ── ATLANTIC 10 EXPANSION ────────────────────────────────────────────────
  { name:"Dayton",           conf:"A10",  w:22, l:12, net:+8.60,  ortg:110.8, drtg:102.4, adjt:68.4, pace:"Med-Fast", sys:"Motion Offense",  tier:2, ca:4, kp:70,  slots:4, coach:"Tamika Williams-Jeter",     tenure:3,  pos:[7,4,2], need:[3,2,1] },
  { name:"VCU",              conf:"A10",  w:24, l:10, net:+10.20, ortg:109.4, drtg:99.2,  adjt:69.0, pace:"Fast",     sys:"Transition",      tier:2, ca:3, kp:67,  slots:4, coach:"Vacant (O'Boyle fired)",      tenure:0,  pos:[7,4,2], need:[3,2,1] },
  ...
  { name:"Saint Joseph's",   conf:"A10",  w:11, l:21, net:-8.60,  ortg:101.8, drtg:110.4, adjt:66.4, pace:"Med-Fast", sys:"Pick & Roll",     tier:3, ca:3, kp:202, slots:5, coach:"Cindy Griffin",       tenure:14,  pos:[7,4,2], need:[3,3,1] },
  { name:"Fordham",          conf:"A10",  w:12, l:20, net:-9.40,  ortg:100.6, drtg:110.2, adjt:66.2, pace:"Med-Fast", sys:"Pick & Roll",     tier:3, ca:3, kp:220, slots:5, coach:"Mike Magpayo",      tenure:0,  pos:[7,4,2], need:[3,3,1] },
];
    ...
    <div style={{display:"flex",alignItems:"center",gap:10}}>
      ...
      <div style={{flex:1,minWidth:0}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:3,flexWrap:"wrap"}}>
          <span style={{fontFamily:"'Archivo',sans-serif",fontSize:13,fontWeight:700,color:p.unavailable?T.textMuted:T.textPrimary}}>{p.name}</span>
  ...
  return <div style={{background:T.bgPanel,border:`1px solid ${T.borderAccent}`,borderRadius:12,padding:"20px",backdropFilter:"blur(20px)",boxShadow:mode==="light"?"0 4px 24px rgba(0,0,0,0.08)":"none"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16}}>
      <div>
        ...
        <h2 style={{fontFamily:"'Archivo',sans-serif",fontSize:12,fontWeight:700,color:p.unavailable?T.textMuted:T.textPrimary,margin:"0 0 4px 0"}}>{p.name}</h2>
  ...
  return <div>
    ...
    <div style={{display:"flex",alignItems:"center",gap:8,background:"rgba(26,107,60,0.07)",border:"1px solid rgba(26,107,60,0.25)",borderRadius:8,padding:"8px 14px",marginBottom:14}}>
      ...
      <span style={{fontFamily:"'DM Mono',monospace",fontSize:12,color:T.accentMid,lineHeight:1.5}}>
        {gender==="women"
          ? <>Warren Nolan data (net rating, pace, W-L) reflects the <strong style={{color:T.accent}}>2025-26 season</strong>. Raw efficiency (not opponent-adjusted). Coach/tenure/CA history fields TBD.</>
          ...
          <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",marginBottom:8,gap:8}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0}}>
              ...
              <div style={{textAlign:"center",background:"rgba(0,230,118,0.06)",border:"1px solid rgba(0,230,118,0.15)",borderRadius:7,padding:"5px 12px"}}>
                ...
                <div style={{fontFamily:"'Playfair Display',serif",fontSize:20,fontWeight:700,color:s.slots!=null?(s.slots>=5?T.accent:s.slots>=3?T.accentMid:T.textSecondary):T.textGhost,lineHeight:1}}>{s.slots!=null?s.slots:"—"}</div>
              </div>
          ...
          <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:8,marginBottom:10}}>
            <div style={{flex:1}}>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:5,flexWrap:"wrap"}}>
                <span style={{fontFamily:"'Archivo',sans-serif",fontSize:12,fontWeight:700,color:T.textPrimary}}>{p.name}</span>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}>
              <div>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4}}>
                  <span style={{fontFamily:"'Archivo',sans-serif",fontSize:11,fontWeight:700,color:T.textPrimary}}>{t.name}</span>
  ...
  return <div style={{maxWidth:860}}>
    ...
    <AboutSection id="methodology" title="Data Sources & Methodology" label="METHODOLOGY" {...sProps}>
      <div style={{display:"grid", gap:7, marginBottom:14}}>
        ...
        <AboutRow T={T} label={gender==="women"?"Warren Nolan data":"KenPom data"} value="2025-26 season" sub="AdjT, net rating, SOS net — used in Schools tab and Fit calculations · ⚠ Update scheduled post-portal (after Apr 21, 2026) once 2025-26 season and portal window are complete"/>
    ...
    <div style={{marginTop:16, padding:"12px 16px", background:T.bgCard, border:`1px solid ${T.borderHr}`, borderRadius:8, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:8}}>
      ...
      <div style={{fontFamily:"'DM Mono',monospace", fontSize:12, color:T.textGhost}}>
        Data: {gender==="women"?"Warren Nolan":"KenPom"} · usports.ca · basketballbuzz.ca · ESPN · Boreal internal research
      </div>
    </div>
...
export default function BorealApp(){
  ...
  return (
    ...
    <div style={{minHeight:"100vh",background:T.bg,color:T.textPrimary,fontFamily:"'DM Mono',monospace",backgroundImage:T.bgGrad,transition:"background 0.3s,color 0.3s"}}>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700;800&family=DM+Mono:wght@400;500;600&family=Bebas+Neue&family=Archivo:wght@500;600;700&display=swap" rel="stylesheet"/>
      <style>{`
      ...
      <div style={{borderTop:`1px solid ${T.borderHr}`,padding:`12px ${px}`,display:"flex",justifyContent:"space-between",alignItems:"center",background:T.bgHeader,flexWrap:"wrap",gap:4}}>
        ...
        {!isMobile&&<span style={{fontSize:12,color:T.textGhost,letterSpacing:0.5}}>{gender==="women"?"Warren Nolan":"KenPom"} · usports.ca · Boreal internal research</span>}
      </div>
      </div>
    </div>

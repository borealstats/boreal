...
const PAST_TRANSFERS = [
  ...
  { id:"past-006", name:"Owen Kenney",             from:"Ottawa (OUA)",      to:"South Alabama", conf:"SBC",   pos:"Forward", uYear:"Y2", season:"2025-26", notes:"6'7\" forward, 14.8 PPG / 6.4 RPG as a sophomore. OUA 3rd Team All-Star, U SPORTS All-Rookie (2024-25). 3 NCAA seasons remaining. 2026 portal class." , profileUrl:"https://usportshoops.ca/history/person.php?Gender=MBB&Person=kenney-owen"},
  { id:"past-007", name:"Oliver Engen",            from:"Queen's (OUA)",     to:"Albany",        conf:"AE",    pos:"Guard",   uYear:"Y2", season:"2025-26", notes:"6'4\" guard, 19.9 PPG / 4.6 APG / 52.8% FG (2025-26). U SPORTS 2nd Team All-Canadian, OUA First Team All-Star, U SPORTS Rookie of the Year (2024-25). First Boreal Analytics placement — Albany responded within 24 hours of our pitch. 2026 portal class." , profileUrl:"https://usportshoops.ca/history/person.php?Gender=MBB&Person=engen-oliver"},
];
...
const NCAA_SCHOOLS_W = [
  ...
  { name:"St. John's",       conf:"BE",   w:22, l:11, net:+3.2,  ortg:94.0,  drtg:90.8,  adjt:69.8, pace:"Med-Fast",     sys:"Moderate-Tempo, Defense-First", tier:1, ca:0, kp:141, slots:4, coach:"Joe Tartamella",               tenure:8, pos:[7,4,2], need:[2,1,1] },
  { name:"Creighton",        conf:"BE",   w:16, l:15, net:+9.0,  ortg:102.1,  drtg:93.1,  adjt:70.6, pace:"Med-Fast",   sys:"Moderate-Tempo, Defense-First", tier:1, ca:0, kp:96,  slots:4, coach:"Jim Flanery",               tenure:8, pos:[8,3,2], need:[2,1,1] },
  ...
  { name:"Seton Hall",       conf:"BE",   w:19, l:12, net:+10.0,  ortg:98.7,  drtg:88.7,  adjt:70.1, pace:"Med-Fast",   sys:"Moderate-Tempo, Defense-First", tier:1, ca:0, kp:88,  slots:4, coach:"Tony Bozzella",               tenure:8, pos:[8,4,1], need:[2,1,1] },
  // Big Ten
  { name:"Michigan",         conf:"B10",  w:25, l:6,  net:+41.6, ortg:117.9, drtg:76.3,  adjt:71.5, pace:"Fast",     sys:"Up-Tempo, Offense-First", tier:1, ca:1, kp:6,   slots:3, coach:"Kim Barnes Arico",               tenure:13, pos:[8,4,2], need:[1,1,1] },
  ...
  { name:"Rutgers",          conf:"B10",  w:9,  l:20, net:-3.5, ortg:92.0,  drtg:95.5, adjt:70.4, pace:"Med-Fast",     sys:"Moderate-Tempo, Defense-First", tier:1, ca:0, kp:207, slots:8, coach:"Gary Redus II",               tenure:2, pos:[6,4,2], need:[4,2,2] },
  ...
  { name:"Duke",             conf:"ACC",  w:24, l:8,  net:+38.8, ortg:112.2, drtg:73.4,  adjt:71.4, pace:"Fast", sys:"Up-Tempo, Offense-First", tier:1, ca:2, kp:9,   slots:3, coach:"Kara Lawson",               tenure:4, pos:[8,4,2], need:[1,1,1] },
  ...
  { name:"Kentucky",         conf:"SEC",  w:23, l:10, net:+34.7, ortg:114.5, drtg:79.8,  adjt:72.5, pace:"Fast",   sys:"Up-Tempo, Offense-First", tier:1, ca:0, kp:15,  slots:4, coach:"Kenny Brooks",               tenure:3, pos:[7,4,2], need:[2,1,1] },
  // Big 12
  ...
  { name:"Baylor",           conf:"B12",  w:24, l:8,  net:+26.3, ortg:106.0,  drtg:79.7,  adjt:71.4, pace:"Fast", sys:"Up-Tempo, Defense-First", tier:1, ca:1, kp:31,  slots:3, coach:"Nicki Collen",               tenure:4, pos:[7,4,2], need:[1,1,1] },
  ...
  // America East
  { name:"Vermont",          conf:"AE",   w:25, l:7,  net:+15.8, ortg:101.3, drtg:85.5,  adjt:66.8, pace:"Medium",     sys:"Controlled-Tempo, Defense-First", tier:2, ca:2, kp:58,  slots:3, coach:"Alisa Kresge",               tenure:8, pos:[7,4,2], need:[1,1,1] },
  ...
  { name:"UMass Lowell",     conf:"AE",   w:15, l:18, net:-24.3, ortg:79.8,  drtg:104.1, adjt:66.6, pace:"Medium",     sys:"Controlled-Tempo, Balanced", tier:3, ca:1, kp:347,slots:5, coach:"Jill Plefka",               tenure:1, pos:[7,4,1], need:[3,1,1] },
  { name:"Albany",           conf:"AE",   w:11, l:21, net:+1.3,  ortg:93.2,  drtg:91.9,  adjt:66.3, pace:"Medium",     sys:"Controlled-Tempo, Defense-First", tier:3, ca:1, kp:157,slots:5, coach:"Kelly Monroe",               tenure:1, pos:[7,4,2], need:[3,1,1] },
  // MWC
  { name:"Boise State",      conf:"MWC",  w:24, l:9,  net:+4.7,  ortg:98.2,  drtg:93.5,  adjt:70.4, pace:"Med-Fast", sys:"Moderate-Tempo, Defense-First", tier:2, ca:1, kp:126, slots:3, coach:"Gordy Presnell",               tenure:8, pos:[7,4,2], need:[1,1,1] },
  ...
  { name:"Colorado State",   conf:"MWC",  w:26, l:7,  net:+14.7, ortg:101.6, drtg:86.9,  adjt:70.3, pace:"Med-Fast",     sys:"Moderate-Tempo, Defense-First", tier:2, ca:0, kp:65,  slots:3, coach:"Ryun Williams",               tenure:8, pos:[7,4,2], need:[1,1,1] },
  // Patriot League
  { name:"Army",             conf:"PL",   w:23, l:7,  net:+9.2, ortg:98.1,  drtg:88.9,  adjt:67.0, pace:"Medium",     sys:"Controlled-Tempo, Defense-First", tier:3, ca:0, kp:93, slots:3, coach:"Dave Kuester",               tenure:1, pos:[7,4,2], need:[1,1,1] },
  { name:"Bucknell",         conf:"PL",   w:10, l:23, net:-13.2, ortg:83.1,  drtg:96.3,  adjt:66.4, pace:"Medium",     sys:"Controlled-Tempo, Defense-First", tier:3, ca:0, kp:287,slots:5, coach:"Aaron Woodruff",               tenure:1, pos:[7,4,2], need:[3,1,1] },
  // Other
  { name:"Bryant",           conf:"AE",   w:16, l:12, net:+0.7,  ortg:91.1,  drtg:90.4,  adjt:66.2, pace:"Medium",     sys:"Controlled-Tempo, Defense-First", tier:3, ca:0, kp:162, slots:4, coach:"Lynne-Ann Kokoski",               tenure:1, pos:[7,4,2], need:[2,1,1] },
  { name:"Quinnipiac",       conf:"MAAC", w:26, l:6,  net:+17.3, ortg:102.3, drtg:85.0,  adjt:69.1, pace:"Med-Fast",     sys:"Moderate-Tempo, Defense-First", tier:2, ca:0, kp:55,  slots:3, coach:"Tricia Fabbri",               tenure:19, pos:[7,4,2], need:[1,1,1] },
];
...
const NCAA_SCHOOLS = [
  ...
  { name:"Michigan",         conf:"B10", w:23, l:12, ortg:116.5, drtg:93.1,  adjt:70.1, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",     tier:1, ca:8, kp:21,  slots:4, coach:"Dusty May",         tenure:1,  pos:[9,4,2], need:[4,1,0] },
  { name:"St. John's",       conf:"BE", w:28, l:7, ortg:114.0, drtg:88.0,  adjt:70.0, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",       tier:1, ca:5, kp:14,  slots:3, coach:"Rick Pitino",       tenure:8,  pos:[8,6,0], need:[1,3,0] },
  { name:"Gonzaga",          conf:"WCC", w:28, l:6, l:9+28.01, ortg:124.7, drtg:96.7,  adjt:70.5, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",  tier:1, ca:7, kp:8,   slots:3, coach:"Mark Few",           tenure:26, pos:[7,5,1], need:[3,3,0] },
  ...
  { name:"Boise State",      conf:"MWC", w:26, l:10, ortg:117.2, drtg:99.0,  adjt:70.8, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",      tier:2, ca:5, kp:43,  slots:4, coach:"Leon Rice",          tenure:8, pos:[7,5,2], need:[3,2,1] },
  { name:"Pittsburgh",       conf:"ACC", w:21, l:14, ortg:114.8, drtg:100.6, adjt:69.8, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",  tier:2, ca:5, kp:52,  slots:4, coach:"Jeff Capel",         tenure:2,  pos:[8,4,2], need:[3,2,1] },
  ...
  { name:"South Carolina",   conf:"SEC", w:15, l:18, ortg:112.6, drtg:100.4, adjt:68.9, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",       tier:2, ca:5, kp:63,  slots:5, coach:"Lamont Paris",      tenure:8,  pos:[8,4,2], need:[3,2,1] },
  { name:"Wake Forest",      conf:"ACC", w:18, l:15,  ortg:112.4, drtg:102.8, adjt:68.2, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",      tier:2, ca:4, kp:81,  slots:4, coach:"Steve Forbes",       tenure:5,  pos:[7,5,2], need:[3,3,0] },
  { name:"Ole Miss",         conf:"SEC", w:22, l:13, ortg:113.2, drtg:101.5, adjt:69.1, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",      tier:2, ca:4, kp:70,  slots:5, coach:"Chris Beard",        tenure:1,  pos:[7,5,2], need:[4,2,1] },
  { name:"Nevada",           conf:"MWC", w:22, l:13,  ortg:111.4, drtg:102.2, adjt:69.5, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",     tier:2, ca:4, kp:88,  slots:5, coach:"Steve Alford",       tenure:9,  pos:[7,4,3], need:[3,2,1] },
  ...
  { name:"George Washington",conf:"A10", w:20, l:14,  ortg:107.1, drtg:103.7, adjt:67.4, pace:"Medium", sys:"Controlled-Tempo, Balanced",       tier:2, ca:4, kp:128, slots:4, coach:"Chris Caputo",    tenure:8,  pos:[7,3,2], need:[3,1,2] },
  { name:"UAB",              conf:"Amer", w:24, l:11, l:13+6.70,  ortg:116.3, drtg:109.6, adjt:69.5, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",       tier:2, ca:4, kp:99,  slots:4, coach:"Andy Kennedy",      tenure:2,  pos:[7,4,1], need:[3,2,1] },
  ...
  { name:"Boston University",conf:"PL", w:16, l:16,  ortg:103.1, drtg:105.2, adjt:67.2, pace:"Medium",      sys:"Controlled-Tempo, Balanced",       tier:2, ca:3, kp:291, slots:4, coach:"Joe Jones",          tenure:8,  pos:[7,4,2], need:[2,2,1] },
  ...
  { name:"Western Michigan", conf:"MAC", w:12, l:20, ortg:101.7, drtg:112.4, adjt:68.0, pace:"Med-Fast", sys:"Moderate-Tempo, Balanced",       tier:3, ca:4, kp:290, slots:5, coach:"Kahil Fennel",   tenure:1,  pos:[7,4,1], need:[4,3,0] },
  ...
  { name:"Ohio",             conf:"MAC", w:20, l:14,  ortg:106.3, drtg:109.1, adjt:70.5, pace:"Med-Fast",     sys:"Moderate-Tempo, Balanced",       tier:3, ca:4, kp:195, slots:3, coach:"Jeff Boals",         tenure:6,  pos:[8,3,1], need:[4,1,1] },
  ...
  { name:"Albany",           conf:"AE", w:16, l:16,  ortg:103.3, drtg:112.5, adjt:67.7, pace:"Medium", sys:"Controlled-Tempo, Balanced",       tier:3, ca:3, kp:275, slots:3, coach:"Dwayne Killings",   tenure:8,  pos:[8,3,1], need:[4,1,0] },
  { name:"Tennessee Tech",   conf:"OVC", w:15, l:17,  ortg:108.4, drtg:110.6, adjt:67.3, pace:"Medium",      sys:"Controlled-Tempo, Balanced",   tier:3, ca:2, kp:168, slots:4, coach:"Tobin Anderson",     tenure:1,  pos:[6,4,2], need:[3,1,1] },

  // ── BIG EAST EXPANSION ───────────────────────────────────────────────────
  { name:"UConn",            conf:"BE", w:24, l:11, ortg:116.8, drtg:94.2,  adjt:71.2, pace:"Fast",     sys:"Up-Tempo, Offense-First",  tier:1, ca:5, kp:5,   slots:3, coach:"Dan Hurley",       tenure:8,  pos:[8,5,1], need:[2,2,0] },
  { name:"Creighton",        conf:"BE", w:25, l:10, ortg:118.6, drtg:100.2, adjt:70.4, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",  tier:1, ca:4, kp:22,  slots:4, coach:"Greg McDermott",   tenure:16, pos:[8,4,1], need:[3,2,0] },
  { name:"Marquette",        conf:"BE", w:12, l:20, ortg:113.4, drtg:101.0, adjt:69.8, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",       tier:1, ca:4, kp:29,  slots:4, coach:"Shaka Smart",      tenure:5,  pos:[8,5,1], need:[3,2,0] },
  ...
  { name:"Villanova",        conf:"BE", w:17, l:17, ortg:114.8, drtg:103.6, adjt:68.8, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",  tier:1, ca:4, kp:50,  slots:4, coach:"Kevin Willard",      tenure:1,  pos:[7,4,2], need:[3,2,0] },
  { name:"Providence",       conf:"BE", w:15, l:18,  ortg:108.6, drtg:104.4, adjt:67.6, pace:"Medium", sys:"Controlled-Tempo, Balanced",       tier:2, ca:4, kp:60,  slots:5, coach:"Bryan Hodgson",       tenure:1,  pos:[7,4,2], need:[3,2,1] },
  { name:"Seton Hall",       conf:"BE", w:13, l:20,  ortg:104.2, drtg:106.8, adjt:67.0, pace:"Medium", sys:"Controlled-Tempo, Balanced",       tier:2, ca:4, kp:91,  slots:5, coach:"Shaheen Holloway",  tenure:8,  pos:[8,4,1], need:[4,2,1] },
  ...
  // ── BIG TEN EXPANSION ────────────────────────────────────────────────────
  { name:"Indiana",          conf:"B10", w:19, l:16, ortg:115.4, drtg:97.2,  adjt:70.8, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",  tier:1, ca:5, kp:30,  slots:4, coach:"Mike Woodson",      tenure:8,  pos:[8,4,2], need:[3,2,1] },
  { name:"Maryland",         conf:"B10", w:20, l:15, ortg:114.6, drtg:97.8,  adjt:70.2, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",       tier:1, ca:5, kp:37,  slots:4, coach:"Buzz Williams",     tenure:1,  pos:[8,4,2], need:[3,2,1] },
  { name:"Rutgers",          conf:"B10", w:16, l:18,  ortg:108.2, drtg:100.4, adjt:68.4, pace:"Med-Fast", sys:"Moderate-Tempo, Balanced",       tier:2, ca:5, kp:80,  slots:4, coach:"Steve Pikiell",     tenure:9, pos:[8,3,2], need:[3,2,1] },

  // ── ACC EXPANSION ────────────────────────────────────────────────────────
  { name:"Syracuse",         conf:"ACC", w:17, l:17, ortg:112.8, drtg:101.2, adjt:68.6, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",  tier:2, ca:6, kp:72,  slots:4, coach:"Gerry McNamara",      tenure:1,  pos:[7,4,2], need:[3,2,1] },
  { name:"Louisville",       conf:"ACC", w:20, l:14, ortg:111.6, drtg:101.4, adjt:68.2, pace:"Med-Fast",     sys:"Moderate-Tempo, Offense-First",      tier:2, ca:4, kp:78,  slots:5, coach:"Pat Kelsey",        tenure:1,  pos:[8,4,2], need:[4,2,1] },
  ...
  { name:"West Virginia",    conf:"B12", w:19, l:15,  ortg:109.6, drtg:101.2, adjt:68.8, pace:"Med-Fast",     sys:"Moderate-Tempo, Balanced",      tier:2, ca:3, kp:81,  slots:4, coach:"Ross Hodge",    tenure:1,  pos:[7,4,2], need:[3,2,1] },
  { name:"Kansas State",     conf:"B12", w:23, l:12, ortg:114.2, drtg:97.0,  adjt:70.2, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",     tier:2, ca:4, kp:32,  slots:4, coach:"Casey Alexander",       tenure:1,  pos:[7,4,2], need:[3,2,1] },

  // ── ATLANTIC 10 EXPANSION ────────────────────────────────────────────────
  { name:"Dayton",           conf:"A10", w:22, l:12,  ortg:110.8, drtg:102.4, adjt:68.4, pace:"Med-Fast", sys:"Moderate-Tempo, Offense-First",  tier:2, ca:4, kp:70,  slots:4, coach:"Anthony Grant",     tenure:8,  pos:[7,4,2], need:[3,2,1] },
  { name:"VCU",              conf:"A10", w:20, l:14, ortg:109.4, drtg:99.2,  adjt:69.0, pace:"Med-Fast",     sys:"Moderate-Tempo, Defense-First",      tier:2, ca:3, kp:67,  slots:4, coach:"Phil Martelli",      tenure:1,  pos:[7,4,2], need:[3,2,1] },
  ...
  { name:"Saint Joseph's",   conf:"A10", w:12, l:20,  ortg:101.8, drtg:110.4, adjt:66.4, pace:"Medium", sys:"Controlled-Tempo, Balanced",     tier:3, ca:3, kp:202, slots:5, coach:"Steve Donahue",       tenure:1,  pos:[7,4,2], need:[3,3,1] },
  { name:"Fordham",          conf:"A10", w:14, l:18,  ortg:100.6, drtg:110.2, adjt:66.2, pace:"Medium", sys:"Controlled-Tempo, Balanced",     tier:3, ca:3, kp:220, slots:5, coach:"Mike Magpayo",      tenure:1,  pos:[7,4,2], need:[3,3,1] },
];
        ...
        return <div key={s.name} style={{
          ...
          <div style={{display:"flex",alignItems:"center",gap:14,flexWrap:"wrap",marginBottom:12}}>
            {[
              ...
              ["Coach", s.coach&&s.coach!=="TBD"?s.coach:"TBD", T.textSecondary]
            ].map(([l,v,c])=>(
        ...
        <div>
          ...
          <div style={{fontFamily:"'Playfair Display',serif",fontSize:12,fontWeight:700,color:portalOpen?(urgency?"#ef5350":T.accent):portalClosed?T.textMuted:T.accent,marginBottom:4}}>
            {portalOpen ? urgency ? `🔴 ${daysRemaining} day${daysRemaining===1?"":"s"} left — final push` : `🟢 Portal open · ${daysRemaining} of ${totalDays} days remaining`
              : portalClosed ? "⬜ Spring window closed · Portal remains open year-round"
          ...
          <div style={{fontFamily:"'DM Mono',monospace",fontSize:12,color:T.textFaint}}>
            {portalOpen ? `Portal closes ${portalCloseLabel} · Players must be entered before deadline`
              : portalClosed ? "Next cycle: review the 2026-27 board, identify Y1–Y3 targets for the spring window"
